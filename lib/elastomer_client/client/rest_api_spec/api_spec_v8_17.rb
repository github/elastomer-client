  ...
  class ApiSpecV8_17 < ApiSpec
    def initialize
      @rest_apis = {
        ...
        "indices.rollover" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "target_failure_store" => {"type"=>"boolean", "description"=>"If set to true, the rollover action will be applied on the failure store of the data stream.", "visibility"=>"feature_flag", "feature_flag"=>"es.failure_store_feature_flag_enabled"},
            }
          }
        ),
        ...
        "inference.stream_inference" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_inference/{inference_id}/_stream", "/_inference/{task_type}/{inference_id}/_stream"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
              "task_type" => {"type"=>"string", "description"=>"The task type"},
            },
