...
module Faraday
  class << self
    # source://faraday//lib/faraday.rb#232
    ...
    #
    # source://faraday//lib/faraday.rb#87
    ...
    #
    # source://faraday//lib/faraday.rb#114
    ...
    #
    # source://faraday//lib/faraday.rb#126
    ...
    # Returns nothing.
    #
    # source://faraday//lib/faraday.rb#77
    ...
    # @return [Boolean]
    #
    # source://faraday//lib/faraday.rb#94
    ...
    # #default_connection.
    #
    # source://faraday//lib/faraday.rb#101
...
class Faraday::Adapter < ::Faraday::Middleware
  ...
  # source://faraday//lib/faraday/adapter.rb#39
  def call(env); end

  private

  # source://faraday//lib/faraday/adapter.rb#45
...
class Faraday::Adapter::EMHttp < ::Faraday::Adapter
  ...
  # source://faraday//lib/faraday/adapter/em_http.rb#153
  def create_request(env); end

  # source://faraday//lib/faraday/adapter/em_http.rb#157
  ...
  # @raise [errklass]
  #
  # source://faraday//lib/faraday/adapter/em_http.rb#161
...
class Faraday::Adapter::EMHttp::Manager
  ...
  #
  # source://faraday//lib/faraday/adapter/em_http.rb#182
  def initialize; end

  # source://faraday//lib/faraday/adapter/em_http.rb#196
  def add(&block); end

  # source://faraday//lib/faraday/adapter/em_http.rb#227
  def check_finished; end

  # source://faraday//lib/faraday/adapter/em_http.rb#221
  def perform_request; end

  # source://faraday//lib/faraday/adapter/em_http.rb#186
  def reset; end

  # source://faraday//lib/faraday/adapter/em_http.rb#205
  def run; end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/em_http.rb#194
  def running?; end
end
...
class Faraday::Adapter::EMSynchrony < ::Faraday::Adapter
  ...
  # source://faraday//lib/faraday/adapter/em_synchrony.rb#91
  def create_request(env); end
...
class Faraday::Adapter::Excon < ::Faraday::Adapter
  ...
  # source://faraday//lib/faraday/adapter/excon.rb#72
  def create_connection(env, opts); end

  # TODO: support streaming requests
  #
  # source://faraday//lib/faraday/adapter/excon.rb#77
  def read_body(env); end
end
...
class Faraday::Adapter::HTTPClient < ::Faraday::Adapter
  ...
  # source://faraday//lib/faraday/adapter/httpclient.rb#100
  def configure_client; end

  # source://faraday//lib/faraday/adapter/httpclient.rb#68
  def configure_proxy(proxy); end

  # source://faraday//lib/faraday/adapter/httpclient.rb#63
  def configure_socket(bind); end

  # source://faraday//lib/faraday/adapter/httpclient.rb#75
  def configure_ssl(ssl); end

  # source://faraday//lib/faraday/adapter/httpclient.rb#87
  def configure_timeouts(req); end

  # source://faraday//lib/faraday/adapter/httpclient.rb#104
  def ssl_cert_store(ssl); end

  # source://faraday//lib/faraday/adapter/httpclient.rb#117
...
class Faraday::Adapter::NetHttp < ::Faraday::Adapter
  ...
  #
  # source://faraday//lib/faraday/adapter/net_http.rb#32
  def initialize(app = T.unsafe(nil), opts = T.unsafe(nil), &block); end

  # source://faraday//lib/faraday/adapter/net_http.rb#37
  def call(env); end
  ...
  # source://faraday//lib/faraday/adapter/net_http.rb#104
  def configure_ssl(http, ssl); end

  # source://faraday//lib/faraday/adapter/net_http.rb#67
  def create_request(env); end

  # source://faraday//lib/faraday/adapter/net_http.rb#96
  def net_http_connection(env); end

  # source://faraday//lib/faraday/adapter/net_http.rb#83
  def perform_request(http, env); end

  # source://faraday//lib/faraday/adapter/net_http.rb#133
  def ssl_cert_store(ssl); end

  # source://faraday//lib/faraday/adapter/net_http.rb#142
  def ssl_verify_mode(ssl); end

  # @yield [net_http_connection(env)]
  #
  # source://faraday//lib/faraday/adapter/net_http.rb#92
...
class Faraday::Adapter::NetHttpPersistent < ::Faraday::Adapter::NetHttp
  ...
  # source://faraday//lib/faraday/adapter/net_http_persistent.rb#51
  def configure_ssl(http, ssl); end

  # source://faraday//lib/faraday/adapter/net_http_persistent.rb#61
  def http_set(http, attr, value); end

  # source://faraday//lib/faraday/adapter/net_http_persistent.rb#8
  def net_http_connection(env); end

  # source://faraday//lib/faraday/adapter/net_http_persistent.rb#37
  def perform_request(http, env); end

  # source://faraday//lib/faraday/adapter/net_http_persistent.rb#23
...
class Faraday::Adapter::Patron < ::Faraday::Adapter
  ...
  # source://faraday//lib/faraday/adapter/patron.rb#69
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/patron.rb#89
  def connection_timed_out_message?(message); end
end

# source://faraday//lib/faraday/adapter/patron.rb#79
...
class Faraday::Adapter::Test < ::Faraday::Adapter
  ...
  #
  # source://faraday//lib/faraday/adapter/test.rb#181
  def initialize(app, stubs = T.unsafe(nil), &block); end

  # source://faraday//lib/faraday/adapter/test.rb#191
  def call(env); end
  ...
  #
  # source://faraday//lib/faraday/adapter/test.rb#40
  def stubs; end
...
class Faraday::Adapter::Test::Stub < ::Struct
  ...
  #
  # source://faraday//lib/faraday/adapter/test.rb#133
  def initialize(host, full, headers, body, block); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#170
  def headers_match?(request_headers); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#141
  def matches?(request_host, request_uri, request_headers, request_body); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/adapter/test.rb#164
  ...
  # source://faraday//lib/faraday/adapter/test.rb#176
  def to_s; end
end
...
class Faraday::Adapter::Test::Stubs
  ...
  # source://faraday//lib/faraday/adapter/test.rb#69
  ...
  # source://faraday//lib/faraday/adapter/test.rb#77
  ...
  # source://faraday//lib/faraday/adapter/test.rb#112
...
class Faraday::CompositeReadIO
  ...
  #
  # source://faraday//lib/faraday/upload_io.rb#18
  def initialize(*parts); end

  # source://faraday//lib/faraday/upload_io.rb#51
  def close; end

  # source://faraday//lib/faraday/upload_io.rb#55
  def ensure_open_and_readable; end

  # source://faraday//lib/faraday/upload_io.rb#24
  def length; end

  # Read from IOs in order until `length` bytes have been received.
  #
  # source://faraday//lib/faraday/upload_io.rb#34
  def read(length = T.unsafe(nil), outbuf = T.unsafe(nil)); end

  # source://faraday//lib/faraday/upload_io.rb#28
  def rewind; end
  ...
  # source://faraday//lib/faraday/upload_io.rb#61
  def current_io; end
end
...
class Faraday::Connection
  ...
  #
  # source://faraday//lib/faraday/connection.rb#60
  ...
  # Returns nothing.
  #
  # source://faraday//lib/faraday/connection.rb#232
  ...
  # Returns nothing.
  #
  # source://faraday//lib/faraday/connection.rb#193
  ...
  #
  # source://faraday//lib/faraday/connection.rb#409
  ...
  #
  # source://faraday//lib/faraday/connection.rb#393
  ...
  #   conn.build_url("nigiri", :page => 2) # => https://sushi.com/api/nigiri?token=abc&page=2
  #
  # source://faraday//lib/faraday/connection.rb#353
  ...
  #
  # source://faraday//lib/faraday/connection.rb#242
  ...
  # source://faraday//lib/faraday/connection.rb#137
  ...
  # source://faraday//lib/faraday/connection.rb#467
  ...
  #
  # source://faraday//lib/faraday/connection.rb#100
  ...
  # Returns nothing.
  #
  # source://faraday//lib/faraday/connection.rb#269
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/connection.rb#259
  def in_parallel?; end
  ...
  #
  # source://faraday//lib/faraday/connection.rb#95
  def params=(hash); end

  # source://faraday//lib/faraday/connection.rb#174
  ...
  #
  # source://faraday//lib/faraday/connection.rb#335
  ...
  #
  # source://faraday//lib/faraday/connection.rb#290
  def proxy=(new_value); end

  # source://faraday//lib/faraday/connection.rb#475
  def proxy_for_request(url); end

  # source://faraday//lib/faraday/connection.rb#447
  ...
  # source://faraday//lib/faraday/connection.rb#441
  ...
  # Returns nothing.
  #
  # source://faraday//lib/faraday/connection.rb#210
  ...
  #
  # source://faraday//lib/faraday/connection.rb#314
  ...
  #
  # source://faraday//lib/faraday/connection.rb#435
...
class Faraday::ConnectionOptions < ::Faraday::Options
  # source://faraday//lib/faraday/options.rb#168
  def builder_class; end

  # source://faraday//lib/faraday/options.rb#262
...
class Faraday::Env < ::Faraday::Options
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#296
  def [](key); end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#324
  def clear_body; end

  # Internal
  #
  # source://faraday//lib/faraday/options.rb#353
  def custom_members; end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#359
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#319
  def needs_body?; end
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#335
  def parallel?; end
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#330
  def parse_body?; end
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#314
  def success?; end

  class << self
    # Public
    #
    # source://faraday//lib/faraday/options.rb#287
    def from(value); end

    # Internal
    #
    # source://faraday//lib/faraday/options.rb#369
    def member_set; end
  end
end

# source://faraday//lib/faraday/options.rb#271
Faraday::Env::ContentLength = T.let(T.unsafe(nil), String)

# A Set of HTTP verbs that typically send a body.  If no body is set for
# these requests, the Content-Length header is set to 0.
#
# source://faraday//lib/faraday/options.rb#277
Faraday::Env::MethodsWithBodies = T.let(T.unsafe(nil), Set)

# source://faraday//lib/faraday/options.rb#272
...
class Faraday::Error < ::StandardError
  ...
  #
  # source://faraday//lib/faraday/error.rb#11
  def initialize(exc, response = T.unsafe(nil)); end

  # source://faraday//lib/faraday/error.rb#17
  def backtrace; end

  # source://faraday//lib/faraday/error.rb#25
  def inspect; end
  ...
  #
  # source://faraday//lib/faraday/error.rb#56
...
class Faraday::Error::ClientError < ::Faraday::ClientError
  class << self
    # source://faraday//lib/faraday/deprecate.rb#17
    def ===(other); end
...
# source://faraday//lib/faraday/deprecate.rb#12
...
module Faraday::FlatParamsEncoder
  class << self
    # source://faraday//lib/faraday/parameters.rb#175
    def decode(query); end

    # source://faraday//lib/faraday/parameters.rb#137
...
module Faraday::MiddlewareRegistry
  # source://faraday//lib/faraday.rb#201
  def fetch_middleware(key); end

  # source://faraday//lib/faraday.rb#205
  ...
  #
  # source://faraday//lib/faraday.rb#188
  def lookup_middleware(key); end

  # source://faraday//lib/faraday.rb#193
  ...
  # Returns nothing.
  #
  # source://faraday//lib/faraday.rb#161
  def register_middleware(autoload_path = T.unsafe(nil), mapping = T.unsafe(nil)); end
end

module Faraday::NestedParamsEncoder
  class << self
    # source://faraday//lib/faraday/parameters.rb#67
    def decode(query); end

    # Internal: convert a nested hash with purely numeric keys into an array.
    # FIXME: this is not compatible with Rack::Utils.parse_nested_query
    #
    # source://faraday//lib/faraday/parameters.rb#118
...
class Faraday::NilStatusError < ::Faraday::ServerError
  ...
  #
  # source://faraday//lib/faraday/error.rb#111
  def initialize(exc, response = T.unsafe(nil)); end
...
class Faraday::Options < ::Struct
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#43
  def clear; end

  # Public
  #
  # source://faraday//lib/faraday/options.rb#64
  def deep_dup; end

  # Public
  #
  # source://faraday//lib/faraday/options.rb#36
  def delete(key); end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#99
  def each_key; end

  # Public
  #
  # source://faraday//lib/faraday/options.rb#114
  def each_value; end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#69
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#107
  def has_key?(key); end
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#122
  def has_value?(value); end

  # Internal
  #
  # source://faraday//lib/faraday/options.rb#139
  def inspect; end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#89
  def keys; end

  # Public
  #
  # source://faraday//lib/faraday/options.rb#59
  def merge(other); end

  # Public
  #
  # source://faraday//lib/faraday/options.rb#48
  def merge!(other); end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#129
  def to_hash; end
  ...
  # Public
  #
  # source://faraday//lib/faraday/options.rb#84
  ...
  class << self
    ...
    # @private
    #
    # source://faraday//lib/faraday/options.rb#189
    def inherited(subclass); end

    # source://faraday//lib/faraday/options.rb#165
    ...
    # Internal
    #
    # source://faraday//lib/faraday/options.rb#151
...
# source://faraday//lib/faraday/upload_io.rb#72
...
class Faraday::ProxyOptions < ::Faraday::Options
  ...
  class << self
    # source://faraday//lib/faraday/options.rb#233
    def from(value); end
  end
end
...
class Faraday::RackBuilder
  ...
  # source://faraday//lib/faraday/rack_builder.rb#100
  ...
  #
  # source://faraday//lib/faraday/rack_builder.rb#194
  ...
  # source://faraday//lib/faraday/rack_builder.rb#174
  def dup; end
  ...
  # source://faraday//lib/faraday/rack_builder.rb#116
  ...
  # source://faraday//lib/faraday/rack_builder.rb#96
  def response(key, *args, &block); end

  # source://faraday//lib/faraday/rack_builder.rb#121
  def swap(index, *args, &block); end

  # source://faraday//lib/faraday/rack_builder.rb#165
  ...
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/rack_builder.rb#212
  def adapter_set?; end

  # source://faraday//lib/faraday/rack_builder.rb#231
  def assert_index(index); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/rack_builder.rb#216
  ...
  # source://faraday//lib/faraday/rack_builder.rb#227
...
class Faraday::Request < ::Struct
  ...
  #
  # source://faraday//lib/faraday/request.rb#42
  def headers=(hash); end
  ...
  # source://faraday//lib/faraday/request.rb#85
  def marshal_load(serialised); end

  # Public: Replace params, preserving the existing hash type
  #
  # source://faraday//lib/faraday/request.rb#33
  def params=(hash); end
  ...
  # :ssl - Hash of options for configuring SSL requests.
  #
  # source://faraday//lib/faraday/request.rb#110
  def to_env(connection); end

  # source://faraday//lib/faraday/request.rb#50
  def url(path, params = T.unsafe(nil)); end

  class << self
    # source://faraday//lib/faraday/request.rb#26
...
class Faraday::Request::Authorization < ::Faraday::Middleware
  ...
  #
  # source://faraday//lib/faraday/request/authorization.rb#27
  def initialize(app, type, token); end

  # Public
  #
  # source://faraday//lib/faraday/request/authorization.rb#33
  def call(env); end
...
class Faraday::Request::Multipart < ::Faraday::Request::UrlEncoded
  # source://faraday//lib/faraday/request/multipart.rb#9
  def call(env); end

  # source://faraday//lib/faraday/request/multipart.rb#36
  def create_multipart(env, params); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/request/multipart.rb#26
  def has_multipart?(obj); end

  # source://faraday//lib/faraday/request/multipart.rb#52
  def process_params(params, prefix = T.unsafe(nil), pieces = T.unsafe(nil), &block); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/request/multipart.rb#18
  def process_request?(env); end

  # source://faraday//lib/faraday/request/multipart.rb#48
  def unique_boundary; end
end

# source://faraday//lib/faraday/request/multipart.rb#7
...
class Faraday::Request::Retry < ::Faraday::Middleware
  ...
  #
  # source://faraday//lib/faraday/request/retry.rb#157
  def build_exception_matcher(exceptions); end

  # source://faraday//lib/faraday/request/retry.rb#117
  def calculate_sleep_amount(retries, env); end

  # source://faraday//lib/faraday/request/retry.rb#126
  def call(env); end
  ...
  #
  # source://faraday//lib/faraday/request/retry.rb#189
  def calculate_retry_after(env); end

  # source://faraday//lib/faraday/request/retry.rb#204
  def calculate_retry_interval(retries); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/request/retry.rb#175
  def retry_request?(env, exception); end

  # source://faraday//lib/faraday/request/retry.rb#179
  def rewind_files(body); end
end

# source://faraday//lib/faraday/request/retry.rb#24
...
class Faraday::Request::Retry::Options < ::Faraday::Options
  # source://faraday//lib/faraday/request/retry.rb#59
  def backoff_factor; end

  # source://faraday//lib/faraday/request/retry.rb#63
  def exceptions; end

  # source://faraday//lib/faraday/request/retry.rb#47
  def interval; end

  # source://faraday//lib/faraday/request/retry.rb#55
  def interval_randomness; end

  # source://faraday//lib/faraday/request/retry.rb#43
  def max; end

  # source://faraday//lib/faraday/request/retry.rb#51
  def max_interval; end

  # source://faraday//lib/faraday/request/retry.rb#67
  def methods; end

  # source://faraday//lib/faraday/request/retry.rb#75
  def retry_block; end

  # source://faraday//lib/faraday/request/retry.rb#71
  def retry_if; end

  # source://faraday//lib/faraday/request/retry.rb#79
  def retry_statuses; end

  class << self
    # source://faraday//lib/faraday/request/retry.rb#35
    def from(value); end
  end
end

# source://faraday//lib/faraday/request/retry.rb#33
...
class Faraday::Response
  ...
  #
  # source://faraday//lib/faraday/response.rb#91
  ...
  # source://faraday//lib/faraday/response.rb#85
...
class Faraday::Response::Logger < ::Faraday::Response::Middleware
  ...
  # source://faraday//lib/faraday/response/logger.rb#22
  def call(env); end
  ...
  # source://faraday//lib/faraday/response/logger.rb#29
  ...
  # source://faraday//lib/faraday/response/logger.rb#72
  def apply_filters(output); end

  # source://faraday//lib/faraday/response/logger.rb#45
  def dump_body(body); end

  # source://faraday//lib/faraday/response/logger.rb#41
  def dump_headers(headers); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/response/logger.rb#65
  def log_body?(type); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/response/logger.rb#58
  def log_headers?(type); end

  # source://faraday//lib/faraday/response/logger.rb#53
...
class Faraday::Response::RaiseError < ::Faraday::Response::Middleware
  ...
  # source://faraday//lib/faraday/response/raise_error.rb#21
...
class Faraday::SSLOptions < ::Faraday::Options
  # @return [Boolean]
  #
  # source://faraday//lib/faraday/options.rb#224
  def disable?; end
...
# source://faraday//lib/faraday.rb#133
...
# source://faraday//lib/faraday/upload_io.rb#71
...
module Faraday::Utils
  ...
  # source://faraday//lib/faraday/utils.rb#192
  def build_query(params); end

  # Recursive hash merge
  #
  # source://faraday//lib/faraday/utils.rb#316
  def deep_merge(source, hash); end

  # Recursive hash update
  #
  # source://faraday//lib/faraday/utils.rb#304
  def deep_merge!(target, hash); end

  # source://faraday//lib/faraday/utils.rb#221
  def default_params_encoder; end

  # source://faraday//lib/faraday/utils.rb#281
  def default_uri_parser; end

  # source://faraday//lib/faraday/utils.rb#288
  def default_uri_parser=(parser); end

  # source://faraday//lib/faraday/utils.rb#202
  def escape(s); end

  # Stolen from Rack
  #
  # source://faraday//lib/faraday/utils.rb#230
  ...
  #
  # source://faraday//lib/faraday/utils.rb#297
  def normalize_path(url); end

  # source://faraday//lib/faraday/utils.rb#217
  ...
  # source://faraday//lib/faraday/utils.rb#208
  def unescape(s); end

  protected

  # source://faraday//lib/faraday/utils.rb#322
  ...
  class << self
    ...
    #
    # source://faraday//lib/faraday/utils.rb#226
    def default_params_encoder=(_arg0); end
  end
end

# source://faraday//lib/faraday/utils.rb#210
...
class Faraday::Utils::Headers < ::Hash
  ...
  # source://faraday//lib/faraday/utils.rb#64
  def fetch(k, *args, &block); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/utils.rb#78
  def has_key?(k); end
  ...
  # source://faraday//lib/faraday/utils.rb#92
  def merge(other); end

  # source://faraday//lib/faraday/utils.rb#86
  def merge!(other); end

  # source://faraday//lib/faraday/utils.rb#106
  def parse(header_string); end

  # source://faraday//lib/faraday/utils.rb#97
  def replace(other); end

  # source://faraday//lib/faraday/utils.rb#104
  def to_hash; end
  ...
  # source://faraday//lib/faraday/utils.rb#130
  def names; end
...
class Faraday::Utils::ParamsHash < ::Hash
  # source://faraday//lib/faraday/utils.rb#137
  def [](key); end

  # source://faraday//lib/faraday/utils.rb#141
  def []=(key, value); end

  # source://faraday//lib/faraday/utils.rb#145
  def delete(key); end

  # @return [Boolean]
  #
  # source://faraday//lib/faraday/utils.rb#149
  def has_key?(key); end
  ...
  # source://faraday//lib/faraday/utils.rb#165
  def merge(params); end

  # source://faraday//lib/faraday/utils.rb#157
  def merge!(params); end

  # source://faraday//lib/faraday/utils.rb#174
  def merge_query(query, encoder = T.unsafe(nil)); end

  # source://faraday//lib/faraday/utils.rb#169
  def replace(other); end

  # source://faraday//lib/faraday/utils.rb#181
  ...
  # source://faraday//lib/faraday/utils.rb#187
