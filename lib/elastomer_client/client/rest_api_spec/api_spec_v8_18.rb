      ...
      @rest_apis = {
        "_internal.delete_desired_balance" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "description"=>"Timeout for connection to master node"},
            }
          }
        ),
        ...
        "autoscaling.delete_autoscaling_policy" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "description"=>"Timeout for processing on master node"},
              "timeout" => {"type"=>"time", "description"=>"Timeout for acknowledgement of update from all nodes in cluster"},
            }
          }
        ),
        ...
        "bulk" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "include_source_on_error" => {"type"=>"boolean", "description"=>"True or false if to include the document source in the error message in case of parsing errors. Defaults to true."},
            }
          }
        ),
        ...
        "cluster.stats" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "include_remotes" => {"type"=>"boolean", "description"=>"Include remote cluster data into the response (default: false)"},
              "timeout" => {"type"=>"time", "description"=>"Explicit operation timeout"},
            }
          }
        ),
        ...
        "esql.async_query_delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/esql-async-query-delete-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "indices.cancel_migrate_reindex" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/data-stream-reindex-cancel-api.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "indices.create_data_stream" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "description"=>"Specify timeout for acknowledging the cluster state update"},
              "master_timeout" => {"type"=>"time", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.create_from" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/indices-create-index-from-source.html",
          methods: ["PUT", "POST"],
        ...
        "indices.get_data_lifecycle_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/data-streams-get-lifecycle-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.get_data_stream" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "include_defaults" => {"type"=>"boolean", "description"=>"Return all relevant default configurations for the data stream (default: false)"},
              "master_timeout" => {"type"=>"time", "description"=>"Specify timeout for connection to master"},
              "verbose" => {"type"=>"boolean", "description"=>"Whether the maximum timestamp for each data stream should be calculated and returned (default: false)"},
            }
          }
        ),
        ...
        "indices.get_migrate_reindex_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/data-stream-reindex-status-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.migrate_reindex" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/data-stream-reindex-api.html",
          methods: ["POST"],
        ...
        "inference.delete" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "description"=>"If true the endpoint will not be deleted and a list of ingest processors which reference this endpoint will be returned.", "required"=>false},
              "force" => {"type"=>"boolean", "description"=>"If true the endpoint will be forcefully stopped (regardless of whether or not it is referenced by any ingest processors or semantic text fields).", "required"=>false},
            }
          }
        ),
        ...
        "inference.update" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/update-inference-api.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
        ...
        "ingest.delete_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/delete-ip-location-database-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ingest.get_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/get-ip-location-database-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ingest.put_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/put-ip-location-database-api.html",
          methods: ["PUT"],
          body: {"description"=>"The database configuration definition", "required"=>true},
          url: {
            path: "/_ingest/ip_location/database/{id}",
        ...
        "ml.update_trained_model_deployment" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "number_of_allocations" => {"type"=>"int", "required"=>false, "description"=>"Update the model deployment to this number of allocations."},
            }
          }
        ),
        ...
        "open_point_in_time" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "allow_partial_search_results" => {"type"=>"boolean", "description"=>"Specify whether to tolerate shards missing when creating the point-in-time, or otherwise throw an exception. (default: false)"},
            }
          }
        ),
        "ping" => RestApi.new(
        ...
        "query_rules.test" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/test-query-ruleset.html",
          methods: ["POST"],
        ...
        "security.delegate_pki" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/security-api-delegate-pki-authentication.html",
          methods: ["POST"],
        ...
        "security.get_settings" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "description"=>"Timeout for connection to master"},
            }
          }
        ),
        ...
        "snapshot.repository_verify_integrity" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "meta_thread_pool_concurrency" => {"type"=>"number", "description"=>"Number of threads to use for reading metadata"},
              "blob_thread_pool_concurrency" => {"type"=>"number", "description"=>"Number of threads to use for reading blob contents"},
              "snapshot_verification_concurrency" => {"type"=>"number", "description"=>"Number of snapshots to verify concurrently"},
              "index_verification_concurrency" => {"type"=>"number", "description"=>"Number of indices to verify concurrently"},
              "index_snapshot_verification_concurrency" => {"type"=>"number", "description"=>"Number of snapshots to verify concurrently within each index"},
              "max_failed_shard_snapshots" => {"type"=>"number", "description"=>"Maximum permitted number of failed shard snapshots"},
              "verify_blob_contents" => {"type"=>"boolean", "description"=>"Whether to verify the contents of individual blobs"},
              "max_bytes_per_sec" => {"type"=>"string", "description"=>"Rate limit for individual blob verification"},
            }
          }
        ),
        ...
        "xpack.info" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_xpack"],
            params: {
              "human" => {"type"=>"boolean", "required"=>false, "description"=>"Defines whether additional human-readable information is included in the response. In particular, it adds descriptions and a tag line. The default value is true.", "default"=>true},
