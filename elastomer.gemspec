...
Gem::Specification.new do |spec|
  ...
  spec.homepage      = "https://github.com/github/elastomer"
  spec.license       = "MIT"
  ...
  spec.add_development_dependency "json",    "~> 1.7" #TODO is this still required? 1.9+ and MultiJson have built in JSON libraries.
