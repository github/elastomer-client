      ...
      @rest_apis = {
        "_internal.delete_desired_balance" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for connection to master node"},
            }
          }
        ),
        "_internal.delete_desired_nodes" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for connection to master node"},
              "timeout" => {"type"=>"time", "description"=>"Timeout for acknowledgements from all nodes"},
            }
          }
        ),
        ...
        "_internal.prevalidate_node_removal" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
        ...
        "async_search.status" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "keep_alive" => {"type"=>"time", "default"=>"5d", "description"=>"Specify the time interval in which the results (partial or final) for this search will be available"},
            }
          }
        ),
        "async_search.submit" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "request_cache" => {"type"=>"boolean", "default"=>true, "description"=>"Specify if request cache should be used for this request or not, defaults to true"},
              ...
              "ccs_minimize_roundtrips" => {"type"=>"boolean", "default"=>false, "description"=>"When doing a cross-cluster search, setting it to true may improve overall search latency, particularly when searching clusters with a large number of shards. However, when set to true, the progress of searches on the remote clusters will not be received until the search finishes on all clusters."},
        ...
        "autoscaling.delete_autoscaling_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/autoscaling-delete-autoscaling-policy.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for processing on master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for acknowledgement of update from all nodes in cluster"},
            }
          }
        ),
        "autoscaling.get_autoscaling_capacity" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/autoscaling-get-autoscaling-capacity.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "autoscaling.put_autoscaling_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/autoscaling-put-autoscaling-policy.html",
          methods: ["PUT"],
        ...
        "bulk" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-bulk.html",
          methods: ["POST", "PUT"],
          ...
          url: {
            ...
            params: {
              ...
              "refresh" => {"type"=>"enum", "options"=>["true", "false", "wait_for"], "default"=>"false", "description"=>"If `true` then refresh the affected shards to make this operation visible to search, if `wait_for` then wait for a refresh to make this operation visible to search, if `false` (the default) then do nothing with refreshes."},
              "routing" => {"type"=>"string", "description"=>"Specific routing value"},
              "timeout" => {"type"=>"time", "default"=>"1m", "description"=>"Explicit operation timeout"},
              ...
              "require_alias" => {"type"=>"boolean", "default"=>false, "description"=>"If true, the request's actions must target an index alias. Defaults to false."},
              "require_data_stream" => {"type"=>"boolean", "default"=>false, "description"=>"If true, the request's actions must target a data stream (existing or to-be-created). Default to false"},
              "list_executed_pipelines" => {"type"=>"boolean", "default"=>false, "description"=>"Sets list_executed_pipelines for all incoming documents. Defaults to unset (false)"},
              "include_source_on_error" => {"type"=>"boolean", "default"=>true, "description"=>"True or false if to include the document source in the error message in case of parsing errors. Defaults to true."},
            }
          }
        ),
        "capabilities" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_capabilities"],
            params: {
              "method" => {"type"=>"enum", "description"=>"REST method to check", "options"=>["GET", "HEAD", "POST", "PUT", "DELETE"], "default"=>"GET"},
              "path" => {"type"=>"string", "description"=>"API path to check"},
              "parameters" => {"type"=>"string", "description"=>"Comma-separated list of API parameters to check"},
              "capabilities" => {"type"=>"string", "description"=>"Comma-separated list of arbitrary API capabilities to check"},
              "local_only" => {"type"=>"boolean", "description"=>"True if only the node being called should be considered", "visibility"=>"private"},
            }
          }
        ),
        "cat.aliases" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-alias.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/aliases",
            ...
            params: {
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              ...
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
        ...
        "cat.allocation" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-allocation.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "local" => {"type"=>"boolean", "default"=>false, "description"=>"Return local information, do not retrieve the state from master node (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "h" => {"type"=>"list", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
        ...
        "cat.component_templates" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-component-templates.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cat.count" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-count.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/count",
        ...
        "cat.fielddata" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-fielddata.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/fielddata",
        ...
        "cat.health" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-health.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/health",
        ...
        "cat.help" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat",
        ...
        "cat.indices" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-indices.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/indices",
        ...
        "cat.master" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-master.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/master",
        ...
        "cat.ml_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-dfanalytics.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to ignore if a wildcard expression matches no configs. (This includes `_all` string or when no configs have been specified)"},
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              "h" => {"type"=>"list", "default"=>"create_time,id,state,type", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
        ...
        "cat.ml_datafeeds" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-datafeeds.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no datafeeds. (This includes `_all` string or when no datafeeds have been specified)"},
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              "h" => {"type"=>"list", "default"=>"['bc', 'id', 'sc', 's']", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
        ...
        "cat.ml_jobs" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-anomaly-detectors.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no jobs. (This includes `_all` string or when no jobs have been specified)"},
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              "h" => {"type"=>"list", "default"=>"buckets.count,data.processed_records,forecasts.total,id,model.bytes,model.memory_status,state", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
        ...
        "cat.ml_trained_models" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-trained-model.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no trained models. (This includes `_all` string or when no trained models have been specified)", "default"=>true},
        ...
        "cat.nodeattrs" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodeattrs.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/nodeattrs",
        ...
        "cat.nodes" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-nodes.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/nodes",
            ...
            params: {
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              "full_id" => {"type"=>"boolean", "default"=>false, "description"=>"Return the full node ID instead of the shortened version (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "h" => {"type"=>"list", "default"=>"ip,hp,rp,r,m,n,cpu,l", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
        ...
        "cat.pending_tasks" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-pending-tasks.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cat.plugins" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-plugins.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/plugins",
        ...
        "cat.recovery" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-recovery.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/recovery",
        ...
        "cat.repositories" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-repositories.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cat.segments" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-segments.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/segments",
            ...
            params: {
              ...
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "ignore_unavailable" => {"type"=>"boolean", "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed). Only allowed when providing an index expression."},
              "ignore_throttled" => {"type"=>"boolean", "description"=>"Whether specified concrete, expanded or aliased indices should be ignored when throttled. Only allowed when providing an index expression."},
              "allow_no_indices" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified). Only allowed when providing an index expression."},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "allow_closed" => {"type"=>"boolean", "description"=>"If true, allow closed indices to be returned in the response otherwise if false, keep the legacy behaviour of throwing an exception if index pattern matches closed indices", "default"=>false},
            }
          }
        ),
        "cat.shards" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-shards.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/shards",
        ...
        "cat.snapshots" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-snapshots.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/snapshots",
        ...
        "cat.tasks" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-tasks.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/tasks",
            ...
            params: {
              ...
              "detailed" => {"type"=>"boolean", "default"=>false, "description"=>"Return detailed task information (default: false)"},
              ...
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a response. If no response is received before the timeout expires, the request fails and returns an error."},
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"If `true`, the request blocks until the task has completed."},
              "bytes" => {"type"=>"enum", "description"=>"The unit in which to display byte values", "options"=>["b", "kb", "mb", "gb", "tb", "pb"]},
            }
          }
        ),
        "cat.templates" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-templates.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cat/templates",
        ...
        "cat.thread_pool" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-thread-pool.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cat.transforms" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cat-transforms.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of transform configs, defaults to 0"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of transforms to get, defaults to 100"},
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no transforms. (This includes `_all` string or when no transforms have been specified)"},
              "format" => {"type"=>"string", "default"=>"text", "description"=>"a short version of the Accept header, e.g. json, yaml"},
              "h" => {"type"=>"list", "default"=>"changes_last_detection_time,checkpoint,checkpoint_progress,documents_processed,id,last_search_time,state", "description"=>"Comma-separated list of column names to display"},
              "help" => {"type"=>"boolean", "description"=>"Return help information", "default"=>false},
              "s" => {"type"=>"list", "description"=>"Comma-separated list of column names or column aliases to sort by"},
              "time" => {"type"=>"enum", "description"=>"The unit in which to display time values", "options"=>["d", "h", "m", "s", "ms", "micros", "nanos"]},
              "v" => {"type"=>"boolean", "description"=>"Verbose mode. Display column headers", "default"=>false},
        ...
        "ccr.delete_auto_follow_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-delete-auto-follow-pattern.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ccr.follow" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-put-follow.html",
          methods: ["PUT"],
        ...
        "ccr.follow_info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-get-follow-info.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ccr.follow_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-get-follow-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
            }
          }
        ),
        "ccr.forget_follower" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-post-forget-follower.html",
          methods: ["POST"],
        ...
        "ccr.get_auto_follow_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-get-auto-follow-pattern.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ccr.pause_auto_follow_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-pause-auto-follow-pattern.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ccr.pause_follow" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-post-pause-follow.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ccr.put_auto_follow_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-put-auto-follow-pattern.html",
          methods: ["PUT"],
        ...
        "ccr.resume_auto_follow_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-resume-auto-follow-pattern.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ccr.resume_follow" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-post-resume-follow.html",
          methods: ["POST"],
        ...
        "ccr.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-get-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ccr/stats",
        ...
        "ccr.unfollow" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ccr-post-unfollow.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "clear_scroll" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clear-scroll-api.html",
          methods: ["DELETE"],
        ...
        "close_point_in_time" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/point-in-time-api.html",
          methods: ["DELETE"],
        ...
        "cluster.allocation_explain" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-allocation-explain.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for connection to master node"},
              "include_yes_decisions" => {"type"=>"boolean", "default"=>false, "description"=>"Return 'YES' decisions in explanation (default: false)"},
              "include_disk_info" => {"type"=>"boolean", "default"=>false, "description"=>"Return information about disk usage and shard sizes (default: false)"},
            }
          }
        ),
        "cluster.delete_component_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-component-template.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "cluster.delete_voting_config_exclusions" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-cluster-post-voting-config-exclusions",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for submitting request to master"},
            }
          }
        ),
        ...
        "cluster.get_component_template" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "local" => {"type"=>"boolean", "default"=>false, "description"=>"Return local information, do not retrieve the state from master node (default: false)"},
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all default configurations for the component template (default: false)"},
              "flat_settings" => {"type"=>"boolean", "default"=>false, "description"=>"Return settings in flat format (default: false)"},
              "settings_filter" => {"type"=>"string", "description"=>"Filter out results, for example to filter out sensitive information. Supports wildcards or full settings keys"},
            }
          }
        ),
        "cluster.get_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-get-settings.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cluster.health" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-health.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "wait_for_active_shards" => {"type"=>"string", "default"=>"0", "description"=>"Wait until the specified number of shards is active"},
              ...
              "wait_for_no_relocating_shards" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to wait until there are no relocating shards in the cluster"},
              "wait_for_no_initializing_shards" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to wait until there are no initializing shards in the cluster"},
        ...
        "cluster.info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-info.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_info/{target}",
        ...
        "cluster.pending_tasks" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-pending.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "cluster.put_component_template" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "cause" => {"type"=>"string", "description"=>"User defined reason for create the component template", "default"=>"api"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "cluster.put_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-update-settings.html",
          methods: ["PUT"],
        ...
        "cluster.remote_info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-remote-info.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_remote/info",
        ...
        "cluster.reroute" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-reroute.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "default"=>false, "description"=>"Simulate the operation only and return the resulting state"},
              "explain" => {"type"=>"boolean", "default"=>false, "description"=>"Return an explanation of why the commands can or cannot be executed"},
              "retry_failed" => {"type"=>"boolean", "default"=>false, "description"=>"Retries allocation of shards that are blocked due to too many subsequent allocation failures"},
              "metric" => {"type"=>"list", "options"=>["_all", "blocks", "metadata", "nodes", "none", "routing_table", "master_node", "version"], "default"=>"all", "description"=>"Limit the information returned to the specified metrics. Defaults to all but metadata"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
            }
          }
        ...
        "cluster.state" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-state.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cluster/state",
            ...
            params: {
              ...
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
            }
          }
        ),
        "cluster.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_cluster/stats",
            ...
            params: {
              "include_remotes" => {"type"=>"boolean", "default"=>false, "description"=>"Include remote cluster data into the response (default: false)"},
              "timeout" => {"type"=>"time", "description"=>"Explicit operation timeout"},
            }
          }
        ),
        "connector.check_in" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/check-in-connector-api.html",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "connector.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-connector-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "delete_sync_jobs" => {"type"=>"boolean", "default"=>false, "description"=>"Determines whether associated sync jobs are also deleted."},
            }
          }
        ),
        "connector.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-connector-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_connector/{connector_id}",
        ...
        "connector.last_sync" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-last-sync-api.html",
          methods: ["PUT"],
        ...
        "connector.list" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/list-connector-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_connector",
        ...
        "connector.post" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-connector-api.html",
          methods: ["POST"],
          body: {"description"=>"The connector configuration.", "required"=>false},
          url: {
            path: "/_connector",
            paths: ["/_connector"],
          }
        ...
        "connector.secret_get" => RestApi.new(
          documentation: "",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "connector.secret_post" => RestApi.new(
          documentation: "",
          methods: ["POST"],
        ...
        "connector.secret_put" => RestApi.new(
          documentation: "",
          methods: ["PUT"],
          body: {"description"=>"The secret value to store", "required"=>true},
          url: {
        ...
        "connector.sync_job_cancel" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cancel-connector-sync-job-api.html",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "connector.sync_job_check_in" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/check-in-connector-sync-job-api.html",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "connector.sync_job_claim" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/claim-connector-sync-job-api.html",
          methods: ["PUT"],
          body: {"description"=>"Data to claim a sync job.", "required"=>true},
          url: {
            path: "/_connector/_sync_job/{connector_sync_job_id}/_claim",
            paths: ["/_connector/_sync_job/{connector_sync_job_id}/_claim"],
            parts: {
              "connector_sync_job_id" => {"type"=>"string", "description"=>"The unique identifier of the connector sync job to be claimed."},
            },
          }
        ),
        "connector.sync_job_delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-connector-sync-job-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "connector.sync_job_error" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/set-connector-sync-job-error-api.html",
          methods: ["PUT"],
        ...
        "connector.sync_job_get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-connector-sync-job-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_connector/_sync_job/{connector_sync_job_id}",
        ...
        "connector.sync_job_list" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/list-connector-sync-jobs-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "connector.sync_job_post" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-connector-sync-job-api.html",
          methods: ["POST"],
        ...
        "connector.sync_job_update_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/set-connector-sync-job-stats-api.html",
          methods: ["PUT"],
        ...
        "connector.update_active_filtering" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-filtering-api.html",
          methods: ["PUT"],
          body: nil,
          url: {
            path: "/_connector/{connector_id}/_filtering/_activate",
            paths: ["/_connector/{connector_id}/_filtering/_activate"],
            parts: {
              "connector_id" => {"type"=>"string", "description"=>"The unique identifier of the connector to be updated."},
            },
          }
        ...
        "connector.update_api_key_id" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-api-key-id-api.html",
          methods: ["PUT"],
        ...
        "connector.update_configuration" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-configuration-api.html",
          methods: ["PUT"],
        ...
        "connector.update_error" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-error-api.html",
          methods: ["PUT"],
        ...
        "connector.update_features" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-features-api.html",
          methods: ["PUT"],
          body: {"description"=>"An object containing the connector's features definition.", "required"=>true},
          url: {
            path: "/_connector/{connector_id}/_features",
            paths: ["/_connector/{connector_id}/_features"],
            parts: {
              "connector_id" => {"type"=>"string", "description"=>"The unique identifier of the connector to be updated."},
            },
          }
        ...
        "connector.update_filtering_validation" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-filtering-validation-api.html",
          methods: ["PUT"],
          body: {"description"=>"Validation info for the draft filtering rules", "required"=>true},
          url: {
            path: "/_connector/{connector_id}/_filtering/_validation",
            paths: ["/_connector/{connector_id}/_filtering/_validation"],
            parts: {
              "connector_id" => {"type"=>"string", "description"=>"The unique identifier of the connector to be updated."},
            },
          }
        ...
        "connector.update_index_name" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-index-name-api.html",
          methods: ["PUT"],
        ...
        "connector.update_name" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-name-description-api.html",
          methods: ["PUT"],
        ...
        "connector.update_native" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-native-api.html",
          methods: ["PUT"],
        ...
        "connector.update_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-pipeline-api.html",
          methods: ["PUT"],
        ...
        "connector.update_scheduling" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-scheduling-api.html",
          methods: ["PUT"],
        ...
        "connector.update_service_type" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-service-type-api.html",
          methods: ["PUT"],
        ...
        "connector.update_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-connector-status-api.html",
          methods: ["PUT"],
        ...
        "count" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-count.html",
          methods: ["POST", "GET"],
          ...
          url: {
            ...
            params: {
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "ignore_throttled" => {"type"=>"boolean", "default"=>true, "description"=>"Whether specified concrete, expanded or aliased indices should be ignored when throttled"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              ...
              "q" => {"type"=>"string", "description"=>"Query in the Lucene query string syntax"},
              "analyzer" => {"type"=>"string", "description"=>"The analyzer to use for the query string"},
              "analyze_wildcard" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether wildcard and prefix queries should be analyzed (default: false)"},
              "default_operator" => {"type"=>"enum", "options"=>["AND", "OR"], "default"=>"OR", "description"=>"The default operator for query string query (AND or OR)"},
              "df" => {"type"=>"string", "description"=>"The field to use as default where no field prefix is given in the query string"},
              "lenient" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether format-based query failures (such as providing text to a numeric field) should be ignored"},
        ...
        "create" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-index_.html",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "pipeline" => {"type"=>"string", "description"=>"The pipeline id to preprocess incoming documents with"},
              "include_source_on_error" => {"type"=>"boolean", "default"=>true, "description"=>"True or false if to include the document source in the error message in case of parsing errors. Defaults to true."},
              "require_alias" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires destination to be an alias. Default is false"},
              "require_data_stream" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires destination to be a data stream (existing or to be created). Default is false"},
            }
          }
        ),
        "dangling_indices.delete_dangling_index" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/dangling-index-delete.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "dangling_indices.import_dangling_index" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/dangling-index-import.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_dangling/{index_uuid}",
        ...
        "dangling_indices.list_dangling_indices" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/dangling-indices-list.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_dangling",
        ...
        "delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-delete.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/{index}/_doc/{id}",
        ...
        "delete_by_query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-delete-by-query.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "default_operator" => {"type"=>"enum", "options"=>["AND", "OR"], "default"=>"OR", "description"=>"The default operator for query string query (AND or OR)"},
              "df" => {"type"=>"string", "description"=>"The field to use as default where no field prefix is given in the query string"},
              "from" => {"type"=>"number", "default"=>0, "description"=>"Starting offset (default: 0)"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              ...
              "refresh" => {"type"=>"boolean", "default"=>false, "description"=>"Should the affected indexes be refreshed?"},
              ...
              "scroll_size" => {"type"=>"number", "default"=>1000, "description"=>"Size on the scroll request powering the delete by query"},
              ...
              "requests_per_second" => {"type"=>"number", "default"=>-1, "description"=>"The throttle for this request in sub-requests per second. -1 means no throttle."},
        ...
        "delete_by_query_rethrottle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-delete-by-query.html#docs-delete-by-query-rethrottle",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "delete_script" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-stored-script-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_scripts/{id}",
        ...
        "enrich.delete_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-enrich-policy-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "enrich.execute_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/execute-enrich-policy-api.html",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "enrich.get_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-enrich-policy-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_enrich/policy/{name}",
        ...
        "enrich.put_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-enrich-policy-api.html",
          methods: ["PUT"],
        ...
        "enrich.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/enrich-stats-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_enrich/_stats",
        ...
        "eql.delete" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-eql-delete",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_eql/search/{id}",
        ...
        "eql.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-search-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_eql/search/{id}",
        ...
        "eql.get_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-eql-status-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "eql.search" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/eql-search-api.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "keep_on_completion" => {"type"=>"boolean", "description"=>"Control whether the response should be stored in the cluster if it completed within the provided [wait_for_completion] time (default: false)", "default"=>false},
              "keep_alive" => {"type"=>"time", "description"=>"Update the time interval in which the results (partial or final) for this search will be available", "default"=>"5d"},
              "allow_partial_search_results" => {"type"=>"boolean", "description"=>"Control whether the query should keep running in case of shard failures, and return partial results", "default"=>true},
              "allow_partial_sequence_results" => {"type"=>"boolean", "description"=>"Control whether a sequence query should return partial results or no results at all in case of shard failures. This option has effect only if [allow_partial_search_results] is true.", "default"=>false},
              ...
              "ignore_unavailable" => {"type"=>"boolean", "default"=>true, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
            }
          }
        ...
        "esql.async_query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/esql-async-query-api.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "delimiter" => {"type"=>"string", "description"=>"The character to use between values within a CSV row. Only valid for the csv format.", "default"=>","},
              ...
              "allow_partial_results" => {"type"=>"boolean", "description"=>"If `true`, partial results will be returned if there are shard failures, but\nthe query can continue to execute on other clusters and shards.\nIf `false`, the entire query will fail if there are\nany failures.", "default"=>true},
            }
          }
        ),
        "esql.async_query_delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/esql-async-query-delete-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "esql.async_query_get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/esql-async-query-get-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_query/async/{id}",
        ...
        "esql.async_query_stop" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/esql-async-query-stop-api.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_query/async/{id}/stop",
            paths: ["/_query/async/{id}/stop"],
            parts: {
              "id" => {"type"=>"string", "description"=>"The async query ID"},
            },
            params: {
              "drop_null_columns" => {"type"=>"boolean", "default"=>false, "description"=>"Indicates whether columns that are entirely `null` will be removed from the `columns` and `values` portion of the results."},
            }
          }
        ),
        "esql.query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/esql-rest.html",
          methods: ["POST"],
          body: {"description"=>"Use the `query` element to start a query. Use `columnar` to format the answer.", "required"=>true},
          url: {
            path: "/_query",
        ...
        "exists" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-get.html",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/{index}/_doc/{id}",
            ...
            params: {
              ...
              "preference" => {"type"=>"string", "description"=>"Specify the node or shard the operation should be performed on (default: random)"},
              "realtime" => {"type"=>"boolean", "default"=>true, "description"=>"Specify whether to perform the operation in realtime or search mode"},
              "refresh" => {"type"=>"boolean", "default"=>false, "description"=>"Refresh the shard containing the document before performing the operation"},
              "routing" => {"type"=>"string", "description"=>"Specific routing value"},
              "_source" => {"type"=>"list", "description"=>"True or false to return the _source field or not, or a list of fields to return"},
              "_source_excludes" => {"type"=>"list", "description"=>"A list of fields to exclude from the returned _source field"},
              "_source_includes" => {"type"=>"list", "description"=>"A list of fields to extract and return from the _source field"},
        ...
        "explain" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-explain.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "analyze_wildcard" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether wildcards and prefix queries in the query string query should be analyzed (default: false)"},
        ...
        "features.get_features" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-features-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_features",
        ...
        "features.reset_features" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/reset-features-api.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "field_caps" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-field-caps.html",
          methods: ["GET", "POST"],
        ...
        "fleet.global_checkpoints" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-global-checkpoints.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "get_script" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-stored-script-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_scripts/{id}",
        ...
        "get_script_context" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-script-contexts-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "get_script_languages" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-script-languages-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "graph.explore" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/graph-explore-api.html",
          methods: ["GET", "POST"],
        ...
        "health_report" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/health-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_health_report",
        ...
        "ilm.delete_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-delete-lifecycle.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ilm.explain_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-explain-lifecycle.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ilm.get_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-get-lifecycle.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ilm/policy/{policy}",
        ...
        "ilm.get_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-get-status.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ilm/status",
        ...
        "ilm.migrate_to_data_tiers" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-migrate-to-data-tiers.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "default"=>false, "description"=>"If set to true it will simulate the migration, providing a way to retrieve the ILM policies and indices that need to be migrated. The default is false"},
            }
          }
        ),
        "ilm.move_to_step" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-move-to-step.html",
          methods: ["POST"],
        ...
        "ilm.put_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-put-lifecycle.html",
          methods: ["PUT"],
        ...
        "ilm.remove_policy" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-remove-policy.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ilm.retry" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-retry-policy.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ilm.start" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-start.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_ilm/start",
        ...
        "ilm.stop" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ilm-stop.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_ilm/stop",
        ...
        "index" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "pipeline" => {"type"=>"string", "description"=>"The pipeline id to preprocess incoming documents with"},
              "require_alias" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires destination to be an alias. Default is false"},
              "require_data_stream" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires the destination to be a data stream (existing or to-be-created). Default is false"},
              "include_source_on_error" => {"type"=>"boolean", "default"=>true, "description"=>"True or false if to include the document source in the error message in case of parsing errors. Defaults to true."},
            }
          }
        ),
        "indices.add_block" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/index-modules-blocks.html#add-index-block",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "indices.analyze" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-analyze",
          methods: ["GET", "POST"],
        ...
        "indices.cancel_migrate_reindex" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migrate-data-stream.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_migration/reindex/{index}/_cancel",
            paths: ["/_migration/reindex/{index}/_cancel"],
            parts: {
              "index" => {"type"=>"string", "description"=>"The index or data stream name"},
            },
          }
        ),
        "indices.clear_cache" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-clearcache.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_cache/clear",
        ...
        "indices.clone" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-clone-index.html",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "wait_for_active_shards" => {"type"=>"string", "default"=>"1", "description"=>"Set the number of active shards to wait for on the cloned index before the operation returns."},
            }
          }
        ),
        "indices.close" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-close.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/{index}/_close",
            ...
            params: {
              ...
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "wait_for_active_shards" => {"type"=>"string", "default"=>"1", "description"=>"Sets the number of active shards to wait for before the operation returns."},
            }
          }
        ),
        "indices.create" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-create-index.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "wait_for_active_shards" => {"type"=>"string", "default"=>"1", "description"=>"Set the number of active shards to wait for before the operation returns."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ...
        "indices.create_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-create-data-stream.html",
          methods: ["PUT"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for acknowledging the cluster state update"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.create_from" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migrate-data-stream.html",
          methods: ["PUT", "POST"],
          body: {"description"=>"The body contains the fields `mappings_override`, `settings_override`, and `remove_index_blocks`.", "required"=>false},
          url: {
            path: "/_create_from/{source}/{dest}",
            paths: ["/_create_from/{source}/{dest}"],
            parts: {
              "source" => {"type"=>"string", "description"=>"The source index name"},
              "dest" => {"type"=>"string", "description"=>"The destination index name"},
            },
          }
        ),
        "indices.data_streams_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/data-stream-stats-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-delete-index.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/{index}",
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Ignore unavailable indexes (default: false)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Ignore if a wildcard expression resolves to no concrete indices (default: false)"},
        ...
        "indices.delete_alias" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-delete-alias.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit timestamp for the document"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.delete_data_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/data-streams-delete-lifecycle.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "indices.delete_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-delete-data-stream.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_data_stream/{name}",
        ...
        "indices.delete_data_stream_options" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_data_stream/{name}/_options",
            paths: ["/_data_stream/{name}/_options"],
            parts: {
              "name" => {"type"=>"list", "description"=>"A comma-separated list of data streams of which the data stream options will be deleted; use `*` to get all data streams"},
            },
            params: {
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether wildcard expressions should get expanded to open or closed indices (default: open)"},
              "timeout" => {"type"=>"time", "description"=>"Explicit timestamp for the document"},
        ...
        "indices.delete_index_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-delete-template.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "indices.delete_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-delete-template-v1.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_template/{name}",
        ...
        "indices.disk_usage" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-disk-usage.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "run_expensive_tasks" => {"type"=>"boolean", "default"=>false, "description"=>"Must be set to [true] in order for the task to be performed. Defaults to false."},
              "flush" => {"type"=>"boolean", "default"=>true, "description"=>"Whether flush or not before analyzing the index disk usage. Defaults to true"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
            }
        ...
        "indices.downsample" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-downsample-data-stream.html",
          methods: ["POST"],
        ...
        "indices.exists" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-exists.html",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/{index}",
        ...
        "indices.exists_alias" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-exists-alias",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/_alias/{name}",
        ...
        "indices.exists_index_template" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-exists-index-template",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/_index_template/{name}",
        ...
        "indices.exists_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-template-exists-v1.html",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/_template/{name}",
        ...
        "indices.explain_data_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/data-streams-explain-lifecycle.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.field_usage_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/field-usage-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.flush" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-flush.html",
          methods: ["POST", "GET"],
          body: nil,
          url: {
            path: "/_flush",
            ...
            params: {
              "force" => {"type"=>"boolean", "default"=>true, "description"=>"Whether a flush should be forced even if it is not necessarily needed ie. if no changes will be committed to the index. This is useful if transaction log IDs should be incremented even if no uncommitted changes are present. (This setting can be considered as internal)"},
              "wait_if_ongoing" => {"type"=>"boolean", "default"=>true, "description"=>"If set to true the flush operation will block until the flush can be executed if another flush operation is already executing. The default is true. If set to false the flush will be skipped iff if another flush operation is already running."},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
            }
        ...
        "indices.forcemerge" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-forcemerge.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_forcemerge",
        ...
        "indices.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-index.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/{index}",
        ...
        "indices.get_alias" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-alias.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_alias",
        ...
        "indices.get_data_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/data-streams-get-lifecycle.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_data_stream/{name}/_lifecycle",
            ...
            params: {
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether wildcard expressions should get expanded to open or closed indices (default: open)"},
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all relevant default configurations for the data stream (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.get_data_lifecycle_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/data-streams-get-lifecycle-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_lifecycle/stats",
            paths: ["/_lifecycle/stats"],
          }
        ),
        "indices.get_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-data-stream.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_data_stream",
            ...
            params: {
              ...
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all relevant default configurations for the data stream (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "verbose" => {"type"=>"boolean", "default"=>false, "description"=>"Whether the maximum timestamp for each data stream should be calculated and returned (default: false)"},
            }
          }
        ),
        "indices.get_data_stream_options" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.get_data_stream_settings" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_data_stream/{name}/_settings"],
            parts: {
              "name" => {"type"=>"string", "description"=>"Comma-separated list of data streams or data stream patterns"},
            },
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a connection to the master node"},
            }
          }
        ),
        "indices.get_field_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-field-mapping.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Whether the default mapping values should be returned as well"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "local" => {"type"=>"boolean", "description"=>"Return local information, do not retrieve the state from master node (default: false)"},
        ...
        "indices.get_index_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-template.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "local" => {"type"=>"boolean", "default"=>false, "description"=>"Return local information, do not retrieve the state from master node (default: false)"},
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all relevant default configurations for the index template (default: false)"},
            }
          }
        ),
        "indices.get_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-mapping.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_mapping",
            ...
            params: {
              ...
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "local" => {"type"=>"boolean", "default"=>false, "description"=>"Return local information, do not retrieve the state from master node (default: false)", "deprecated"=>{"version"=>"7.8.0", "description"=>"This parameter is a no-op and field mappings are always retrieved locally."}},
            }
          }
        ),
        "indices.get_migrate_reindex_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migrate-data-stream.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_migration/reindex/{index}/_status",
            paths: ["/_migration/reindex/{index}/_status"],
            parts: {
              "index" => {"type"=>"string", "description"=>"The index or data stream name"},
            },
          }
        ...
        "indices.get_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-settings.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_settings",
        ...
        "indices.get_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-get-template-v1.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_template",
        ...
        "indices.migrate_reindex" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migrate-data-stream.html",
          methods: ["POST"],
          body: {"description"=>"The body contains the fields `mode` and `source.index, where the only mode currently supported is `upgrade`, and the `source.index` must be a data stream name", "required"=>true},
          url: {
            path: "/_migration/reindex",
            paths: ["/_migration/reindex"],
          }
        ),
        "indices.migrate_to_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-migrate-to-data-stream",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "indices.modify_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-modify-data-stream",
          methods: ["POST"],
        ...
        "indices.open" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-open-close.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/{index}/_open",
        ...
        "indices.promote_data_stream" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-promote-data-stream",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "indices.put_alias" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-put-alias",
          methods: ["PUT", "POST"],
        ...
        "indices.put_data_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-put-data-lifecycle",
          methods: ["PUT"],
        ...
        "indices.put_data_stream_options" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/current/index.html",
          methods: ["PUT"],
          body: {"description"=>"The data stream options configuration that consist of the failure store configuration"},
          url: {
            path: "/_data_stream/{name}/_options",
            paths: ["/_data_stream/{name}/_options"],
            parts: {
              "name" => {"type"=>"list", "description"=>"A comma-separated list of data streams whose options will be updated; use `*` to set the options to all data streams"},
            },
            params: {
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether wildcard expressions should get expanded to open or closed indices (default: open)"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit timestamp for the document"},
        ...
        "indices.put_data_stream_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/data-streams.html",
          methods: ["PUT"],
          body: {"description"=>"The data stream settings to be updated", "required"=>true},
          url: {
            path: "/_data_stream/{name}/_settings",
            paths: ["/_data_stream/{name}/_settings"],
            parts: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "description"=>"Whether this request should only be a dry run rather than actually applying settings", "default"=>false},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a response"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a connection to the master node"},
            }
          }
        ),
        "indices.put_index_template" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-put-index-template",
          methods: ["PUT", "POST"],
          body: {"description"=>"The template definition", "required"=>true},
          url: {
            path: "/_index_template/{name}",
            ...
            params: {
              "create" => {"type"=>"boolean", "description"=>"Whether the index template should only be added if new or can also replace an existing one", "default"=>false},
              "cause" => {"type"=>"string", "description"=>"User defined reason for creating/updating the index template", "default"=>"api"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.put_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-put-mapping.html",
          methods: ["PUT", "POST"],
        ...
        "indices.put_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-update-settings.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "preserve_existing" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to update existing settings. If set to `true` existing settings on an index remain unchanged, the default is `false`"},
              "reopen" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to close and reopen the index to apply non-dynamic settings. If set to `true` the indices to which the settings are being applied will be closed temporarily and then reopened in order to apply the changes. The default is `false`"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "flat_settings" => {"type"=>"boolean", "default"=>false, "description"=>"Return settings in flat format (default: false)"},
            }
          }
        ...
        "indices.put_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-templates-v1.html",
          methods: ["PUT", "POST"],
          body: {"description"=>"The template definition", "required"=>true},
          url: {
            path: "/_template/{name}",
            ...
            params: {
              ...
              "create" => {"type"=>"boolean", "description"=>"Whether the index template should only be added if new or can also replace an existing one", "default"=>false},
              "cause" => {"type"=>"string", "description"=>"User defined reason for creating/updating the index template", "default"=>""},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.recovery" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-recovery.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_recovery",
            ...
            params: {
              ...
              "ignore_unavailable" => {"type"=>"boolean", "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)", "default"=>false},
              "allow_no_indices" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)", "default"=>true},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
            }
          }
        ),
        "indices.refresh" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-refresh.html",
          methods: ["POST", "GET"],
          body: nil,
          url: {
            path: "/_refresh",
        ...
        "indices.reload_search_analyzers" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-reload-analyzers.html",
          methods: ["GET", "POST"],
          body: nil,
          url: {
        ...
        "indices.resolve_cluster" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-resolve-cluster-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_resolve/cluster",
            paths: ["/_resolve/cluster", "/_resolve/cluster/{name}"],
            parts: {
              "name" => {"type"=>"list", "description"=>"A comma-separated list of cluster:index names or wildcard expressions"},
            },
            params: {
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed). Only allowed when providing an index expression."},
              "ignore_throttled" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete, expanded or aliased indices should be ignored when throttled. Only allowed when providing an index expression."},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified). Only allowed when providing an index expression."},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether wildcard expressions should get expanded to open or closed indices (default: open). Only allowed when providing an index expression."},
              "timeout" => {"type"=>"time", "description"=>"The maximum time to wait for remote clusters to respond"},
            }
          }
        ),
        "indices.resolve_index" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-resolve-index-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "indices.rollover" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-rollover-index.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "dry_run" => {"type"=>"boolean", "default"=>false, "description"=>"If set to true the rollover action will only be validated but not actually performed even if a condition matches. The default is false"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "wait_for_active_shards" => {"type"=>"string", "default"=>"1", "description"=>"Set the number of active shards to wait for on the newly created rollover index before the operation returns."},
        ...
        "indices.segments" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-segments.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_segments",
        ...
        "indices.shard_stores" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-shards-stores.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_shard_stores",
        ...
        "indices.shrink" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-shrink-index.html",
          methods: ["PUT", "POST"],
          body: {"description"=>"The configuration for the target index (`settings` and `aliases`)"},
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "wait_for_active_shards" => {"type"=>"string", "default"=>"1", "description"=>"Set the number of active shards to wait for on the shrunken index before the operation returns."},
            }
          }
        ),
        "indices.simulate_index_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-simulate-index.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all relevant default configurations for this index template simulation (default: false)"},
            }
          }
        ),
        "indices.simulate_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-simulate-template.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "cause" => {"type"=>"string", "description"=>"User defined reason for dry-run creating the new template for simulation purposes", "default"=>"false"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
              "include_defaults" => {"type"=>"boolean", "default"=>false, "description"=>"Return all relevant default configurations for this template simulation (default: false)"},
            }
          }
        ),
        "indices.split" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-split-index.html",
          methods: ["PUT", "POST"],
          body: {"description"=>"The configuration for the target index (`settings` and `aliases`)"},
          url: {
        ...
        "indices.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/indices-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_stats",
        ...
        "indices.unfreeze" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/unfreeze-index-api.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "indices.update_aliases" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-update-aliases",
          methods: ["POST"],
          ...
          url: {
            ...
            paths: ["/_aliases"],
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Request timeout"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "indices.validate_query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-validate.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "explain" => {"type"=>"boolean", "default"=>false, "description"=>"Return detailed information about the error"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "q" => {"type"=>"string", "description"=>"Query in the Lucene query string syntax"},
              ...
              "df" => {"type"=>"string", "description"=>"The field to use as default where no field prefix is given in the query string"},
              "lenient" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether format-based query failures (such as providing text to a numeric field) should be ignored"},
              "rewrite" => {"type"=>"boolean", "default"=>false, "description"=>"Provide a more detailed explanation showing the actual Lucene query that will be executed."},
              "all_shards" => {"type"=>"boolean", "default"=>false, "description"=>"Execute validation on all shards instead of one random shard per index"},
            }
          }
        ),
        "inference.chat_completion_unified" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/chat-completion-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/chat_completion/{inference_id}/_stream",
            paths: ["/_inference/chat_completion/{inference_id}/_stream"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.completion" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/post-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/completion/{inference_id}",
            paths: ["/_inference/completion/{inference_id}"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-inference-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "default"=>false, "description"=>"If true the endpoint will not be deleted and a list of ingest processors which reference this endpoint will be returned."},
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"If true the endpoint will be forcefully stopped (regardless of whether or not it is referenced by any ingest processors or semantic text fields)."},
            }
          }
        ),
        "inference.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-inference-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_inference",
            paths: ["/_inference", "/_inference/{inference_id}", "/_inference/{task_type}/{inference_id}"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
              "task_type" => {"type"=>"string", "description"=>"The task type"},
            },
        ...
        "inference.put" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-inference-api.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{inference_id}",
            paths: ["/_inference/{inference_id}", "/_inference/{task_type}/{inference_id}"],
            parts: {
        ...
        "inference.put_alibabacloud" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-alibabacloud-ai-search.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{alibabacloud_inference_id}",
            paths: ["/_inference/{task_type}/{alibabacloud_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "alibabacloud_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_amazonbedrock" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-amazon-bedrock.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{amazonbedrock_inference_id}",
            paths: ["/_inference/{task_type}/{amazonbedrock_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "amazonbedrock_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_amazonsagemaker" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_inference/{task_type}/{amazonsagemaker_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "amazonsagemaker_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_anthropic" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-anthropic.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{anthropic_inference_id}",
            paths: ["/_inference/{task_type}/{anthropic_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "anthropic_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_azureaistudio" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-azure-ai-studio.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{azureaistudio_inference_id}",
            paths: ["/_inference/{task_type}/{azureaistudio_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "azureaistudio_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_azureopenai" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-azure-openai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{azureopenai_inference_id}",
            paths: ["/_inference/{task_type}/{azureopenai_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "azureopenai_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_cohere" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-cohere.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{cohere_inference_id}",
            paths: ["/_inference/{task_type}/{cohere_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "cohere_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_custom" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_inference/{task_type}/{custom_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "custom_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_deepseek" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-deepseek.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{deepseek_inference_id}",
            paths: ["/_inference/{task_type}/{deepseek_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "deepseek_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_elasticsearch" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-elasticsearch.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{elasticsearch_inference_id}",
            paths: ["/_inference/{task_type}/{elasticsearch_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "elasticsearch_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_elser" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-elser.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{elser_inference_id}",
            paths: ["/_inference/{task_type}/{elser_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "elser_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_googleaistudio" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-google-ai-studio.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{googleaistudio_inference_id}",
            paths: ["/_inference/{task_type}/{googleaistudio_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "googleaistudio_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_googlevertexai" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-google-vertex-ai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{googlevertexai_inference_id}",
            paths: ["/_inference/{task_type}/{googlevertexai_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "googlevertexai_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_hugging_face" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-hugging-face.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{huggingface_inference_id}",
            paths: ["/_inference/{task_type}/{huggingface_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "huggingface_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_jinaai" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-jinaai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{jinaai_inference_id}",
            paths: ["/_inference/{task_type}/{jinaai_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "jinaai_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_mistral" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-mistral.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{mistral_inference_id}",
            paths: ["/_inference/{task_type}/{mistral_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "mistral_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.put_openai" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-openai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{openai_inference_id}",
            paths: ["/_inference/{task_type}/{openai_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "openai_inference_id" => {"type"=>"string", "description"=>"The inference ID"},
            },
          }
        ),
        "inference.put_voyageai" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-voyageai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{voyageai_inference_id}",
            paths: ["/_inference/{task_type}/{voyageai_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "voyageai_inference_id" => {"type"=>"string", "description"=>"The inference ID"},
            },
          }
        ),
        "inference.put_watsonx" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-service-watsonx-ai.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{task_type}/{watsonx_inference_id}",
            paths: ["/_inference/{task_type}/{watsonx_inference_id}"],
            parts: {
              "task_type" => {"type"=>"string", "description"=>"The task type"},
              "watsonx_inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.rerank" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/post-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/rerank/{inference_id}",
            paths: ["/_inference/rerank/{inference_id}"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.sparse_embedding" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/post-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/sparse_embedding/{inference_id}",
            paths: ["/_inference/sparse_embedding/{inference_id}"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.stream_completion" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/stream-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/completion/{inference_id}/_stream",
            paths: ["/_inference/completion/{inference_id}/_stream"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.text_embedding" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/post-inference-api.html",
          methods: ["POST"],
          body: {"description"=>"The inference payload"},
          url: {
            path: "/_inference/text_embedding/{inference_id}",
            paths: ["/_inference/text_embedding/{inference_id}"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
            },
          }
        ),
        "inference.update" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/update-inference-api.html",
          methods: ["PUT"],
          body: {"description"=>"The inference endpoint's task and service settings"},
          url: {
            path: "/_inference/{inference_id}/_update",
            paths: ["/_inference/{inference_id}/_update", "/_inference/{task_type}/{inference_id}/_update"],
            parts: {
              "inference_id" => {"type"=>"string", "description"=>"The inference Id"},
              "task_type" => {"type"=>"string", "description"=>"The task type"},
            },
        ...
        "info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rest-api-root.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/",
        ...
        "ingest.delete_geoip_database" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-delete-geoip-database",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_ingest/geoip/database/{id}",
            paths: ["/_ingest/geoip/database/{id}"],
            parts: {
              "id" => {"type"=>"list", "description"=>"A comma-separated list of geoip database configurations to delete"},
            },
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
        ...
        "ingest.delete_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-ip-location-database-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_ingest/ip_location/database/{id}",
            paths: ["/_ingest/ip_location/database/{id}"],
            parts: {
              "id" => {"type"=>"list", "description"=>"A comma-separated list of ip location database configurations to delete"},
            },
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
        ...
        "ingest.delete_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-pipeline-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ingest.geo_ip_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/geoip-processor.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ingest.get_geoip_database" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-get-geoip-database",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ingest/geoip/database",
            paths: ["/_ingest/geoip/database", "/_ingest/geoip/database/{id}"],
            parts: {
              "id" => {"type"=>"list", "description"=>"A comma-separated list of geoip database configurations to get; use `*` to get all geoip database configurations"},
            },
          }
        ),
        "ingest.get_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-ip-location-database-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ingest/ip_location/database",
            paths: ["/_ingest/ip_location/database", "/_ingest/ip_location/database/{id}"],
            parts: {
              "id" => {"type"=>"list", "description"=>"A comma-separated list of ip location database configurations to get; use `*` to get all ip location database configurations"},
            },
          }
        ),
        "ingest.get_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-pipeline-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "summary" => {"type"=>"boolean", "default"=>false, "description"=>"Return pipelines without their definitions (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
            }
          }
        ),
        "ingest.processor_grok" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/grok-processor.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ingest.put_geoip_database" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-put-geoip-database",
          methods: ["PUT"],
          body: {"description"=>"The database configuration definition", "required"=>true},
          url: {
            path: "/_ingest/geoip/database/{id}",
            paths: ["/_ingest/geoip/database/{id}"],
            parts: {
              "id" => {"type"=>"string", "description"=>"The id of the database configuration"},
            },
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
        ...
        "ingest.put_ip_location_database" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-ip-location-database-api.html",
          methods: ["PUT"],
          body: {"description"=>"The database configuration definition", "required"=>true},
          url: {
            path: "/_ingest/ip_location/database/{id}",
        ...
        "ingest.put_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ingest.html",
          methods: ["PUT"],
        ...
        "ingest.simulate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/simulate-pipeline-api.html",
          methods: ["GET", "POST"],
        ...
        "license.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-license.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_license",
        ...
        "license.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-license.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_license",
            paths: ["/_license"],
            params: {
              "local" => {"type"=>"boolean", "default"=>true, "description"=>"Return local information, do not retrieve the state from master node (default: false)"},
              "accept_enterprise" => {"type"=>"boolean", "deprecated"=>true, "default"=>true, "description"=>"Supported for backwards compatibility with 7.x. If this param is used it must be set to true"},
            }
          }
        ),
        "license.get_basic_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-basic-status.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "license.get_trial_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-trial-status.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "license.post" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-license-post",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            paths: ["/_license"],
            params: {
              "acknowledge" => {"type"=>"boolean", "default"=>false, "description"=>"whether the user has acknowledged acknowledge messages (default: false)"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for processing on master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for acknowledgement of update from all nodes in cluster"},
            }
          }
        ...
        "license.post_start_basic" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/start-basic.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "license.post_start_trial" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/start-trial.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "logstash.delete_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/logstash-api-delete-pipeline.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "logstash.get_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/logstash-api-get-pipeline.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "logstash.put_pipeline" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/logstash-api-put-pipeline.html",
          methods: ["PUT"],
        ...
        "mget" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-multi-get.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "force_synthetic_source" => {"type"=>"boolean", "description"=>"Should this request force synthetic _source? Use this to test if the mapping supports synthetic _source and to get a sense of the worst case performance. Fetches with this enabled will be slower the enabling synthetic source natively in the index.", "visibility"=>"feature_flag", "feature_flag"=>"es.index_mode_feature_flag_registered"},
              "stored_fields" => {"type"=>"list", "default"=>"false", "description"=>"A comma-separated list of stored fields to return in the response"},
              "preference" => {"type"=>"string", "description"=>"Specify the node or shard the operation should be performed on (default: random)"},
              "realtime" => {"type"=>"boolean", "default"=>true, "description"=>"Specify whether to perform the operation in realtime or search mode"},
              "refresh" => {"type"=>"boolean", "default"=>false, "description"=>"Refresh the shard containing the document before performing the operation"},
              "routing" => {"type"=>"string", "description"=>"Specific routing value"},
        ...
        "migration.deprecations" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/migration-api-deprecation.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "migration.get_feature_upgrade_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/feature-migration-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ml.clear_trained_model_deployment_cache" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clear-trained-model-deployment-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ml.close_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-close-job.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no jobs. (This includes `_all` string or when no jobs have been specified)"},
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"True if the job should be forcefully closed"},
              "timeout" => {"type"=>"time", "default"=>"30m", "description"=>"Controls the time to wait until a job has closed. Default to 30 minutes"},
            }
          }
        ),
        "ml.delete_calendar" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-calendar.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_calendar_event" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-calendar-event.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_calendar_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-calendar-job.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-dfanalytics.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "timeout" => {"type"=>"time", "default"=>"1m", "description"=>"Controls the time to wait until a job is deleted. Defaults to 1 minute"},
            }
          }
        ),
        "ml.delete_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-datafeed.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "force" => {"type"=>"boolean", "description"=>"True if the datafeed should be forcefully deleted"},
            }
          }
        ),
        "ml.delete_expired_data" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-expired-data.html",
          methods: ["DELETE"],
          ...
          url: {
            ...
            params: {
              "requests_per_second" => {"type"=>"number", "description"=>"The desired requests per second for the deletion processes."},
              "timeout" => {"type"=>"time", "default"=>"8h", "description"=>"How long can the underlying delete processes run until they are canceled"},
            }
          }
        ),
        "ml.delete_filter" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-filter.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_forecast" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-forecast.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_forecasts" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if `_all` matches no forecasts"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait until the forecast(s) are deleted. Default to 30 seconds"},
            }
          }
        ),
        "ml.delete_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-job.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_model_snapshot" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-delete-snapshot.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.delete_trained_model" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-trained-models.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "description"=>"Controls the amount of time to wait for the model to be deleted.", "default"=>"30s"},
              "force" => {"type"=>"boolean", "description"=>"True if the model should be forcefully deleted"},
            }
          }
        ),
        "ml.delete_trained_model_alias" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-trained-models-aliases.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "ml.estimate_model_memory" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-estimate-model-memory.html",
          methods: ["POST"],
        ...
        "ml.evaluate_data_frame" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/evaluate-dfanalytics.html",
          methods: ["POST"],
        ...
        "ml.explain_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/explain-dfanalytics.html",
          methods: ["GET", "POST"],
        ...
        "ml.flush_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-flush-job.html",
          methods: ["POST"],
        ...
        "ml.forecast" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-forecast.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "duration" => {"type"=>"time", "default"=>"1d", "description"=>"The duration of the forecast"},
              "expires_in" => {"type"=>"time", "default"=>"14d", "description"=>"The time interval after which the forecast expires. Expired forecasts will be deleted at the first opportunity."},
              "max_model_memory" => {"type"=>"string", "default"=>"20mb", "description"=>"The max memory able to be used by the forecast. Default is 20mb."},
            }
          }
        ),
        "ml.get_buckets" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-bucket.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "expand" => {"type"=>"boolean", "default"=>false, "description"=>"Include anomaly records"},
              "exclude_interim" => {"type"=>"boolean", "default"=>false, "description"=>"Exclude interim results"},
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of buckets"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of buckets to get"},
              "start" => {"type"=>"string", "default"=>"-1", "description"=>"Start time filter for buckets"},
              "end" => {"type"=>"string", "default"=>"-1", "description"=>"End time filter for buckets"},
              "anomaly_score" => {"type"=>"double", "default"=>0, "description"=>"Filter for the most anomalous buckets"},
              "sort" => {"type"=>"string", "default"=>"timestamp", "description"=>"Sort buckets by a particular field"},
              "desc" => {"type"=>"boolean", "default"=>false, "description"=>"Set the sort direction"},
            }
          }
        ),
        "ml.get_calendar_events" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-calendar-event.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "from" => {"type"=>"int", "default"=>0, "description"=>"Skips a number of events"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"Specifies a max number of events to get"},
            }
          }
        ),
        "ml.get_calendars" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-calendar.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of calendars"},
              "size" => {"type"=>"int", "default"=>10000, "description"=>"specifies a max number of calendars to get"},
            }
          }
        ),
        "ml.get_categories" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-category.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of categories"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of categories to get"},
        ...
        "ml.get_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-dfanalytics.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/data_frame/analytics/{id}",
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no data frame analytics. (This includes `_all` string or when no data frame analytics have been specified)", "default"=>true},
              ...
              "exclude_generated" => {"type"=>"boolean", "default"=>false, "description"=>"Omits fields that are illegal to set on data frame analytics PUT"},
            }
          }
        ),
        "ml.get_data_frame_analytics_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-dfanalytics-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              ...
              "from" => {"type"=>"int", "description"=>"skips a number of analytics", "default"=>0},
              "size" => {"type"=>"int", "description"=>"specifies a max number of analytics to get", "default"=>100},
              "verbose" => {"type"=>"boolean", "description"=>"whether the stats response should be verbose", "default"=>false},
            }
          }
        ),
        "ml.get_datafeed_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-datafeed-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no datafeeds. (This includes `_all` string or when no datafeeds have been specified)"},
            }
          }
        ),
        "ml.get_datafeeds" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-datafeed.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/datafeeds/{datafeed_id}",
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no datafeeds. (This includes `_all` string or when no datafeeds have been specified)"},
              "exclude_generated" => {"type"=>"boolean", "default"=>false, "description"=>"Omits fields that are illegal to set on datafeed PUT"},
            }
          }
        ),
        "ml.get_filters" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-filter.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/filters",
            ...
            params: {
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of filters"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of filters to get"},
            }
          }
        ),
        "ml.get_influencers" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-influencer.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "exclude_interim" => {"type"=>"boolean", "default"=>false, "description"=>"Exclude interim results"},
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of influencers"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of influencers to get"},
              "start" => {"type"=>"string", "default"=>"-1", "description"=>"start timestamp for the requested influencers"},
              "end" => {"type"=>"string", "default"=>"-1", "description"=>"end timestamp for the requested influencers"},
              "influencer_score" => {"type"=>"double", "default"=>0, "description"=>"influencer score threshold for the requested influencers"},
              "sort" => {"type"=>"string", "description"=>"sort field for the requested influencers"},
              "desc" => {"type"=>"boolean", "default"=>false, "description"=>"whether the results should be sorted in decending order"},
            }
          }
        ),
        "ml.get_job_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-job-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ml.get_jobs" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-job.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/anomaly_detectors/{job_id}",
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no jobs. (This includes `_all` string or when no jobs have been specified)"},
              "exclude_generated" => {"type"=>"boolean", "default"=>false, "description"=>"Omits fields that are illegal to set on job PUT"},
            }
          }
        ),
        "ml.get_memory_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-ml-memory.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ml.get_model_snapshot_upgrade_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-job-model-snapshot-upgrade-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no jobs or no snapshots. (This includes the `_all` string.)"},
            }
          }
        ),
        "ml.get_model_snapshots" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-snapshot.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "from" => {"type"=>"int", "default"=>0, "description"=>"Skips a number of documents"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"The default number of documents returned in queries as a string."},
              ...
              "desc" => {"type"=>"boolean", "default"=>false, "description"=>"True if the results should be sorted in descending order"},
            }
          }
        ),
        "ml.get_overall_buckets" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-overall-buckets.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "top_n" => {"type"=>"int", "default"=>1, "description"=>"The number of top job bucket scores to be used in the overall_score calculation"},
              ...
              "exclude_interim" => {"type"=>"boolean", "default"=>false, "description"=>"If true overall buckets that include interim buckets will be excluded"},
        ...
        "ml.get_records" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-get-record.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "exclude_interim" => {"type"=>"boolean", "default"=>false, "description"=>"Exclude interim results"},
              "from" => {"type"=>"int", "default"=>0, "description"=>"skips a number of records"},
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of records to get"},
              "start" => {"type"=>"string", "default"=>"-1", "description"=>"Start time filter for records"},
              "end" => {"type"=>"string", "default"=>"-1", "description"=>"End time filter for records"},
              "record_score" => {"type"=>"double", "default"=>0, "description"=>"Returns records with anomaly scores greater or equal than this value"},
              "sort" => {"type"=>"string", "default"=>"record_score", "description"=>"Sort records by a particular field"},
              "desc" => {"type"=>"boolean", "default"=>false, "description"=>"Set the sort direction"},
            }
          }
        ),
        "ml.get_trained_models" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-trained-models.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/trained_models/{model_id}",
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard expression matches no trained models. (This includes `_all` string or when no trained models have been specified)", "default"=>true},
              "include" => {"type"=>"string", "description"=>"A comma-separate list of fields to optionally include. Valid options are 'definition' and 'total_feature_importance'. Default is none."},
              "include_model_definition" => {"type"=>"boolean", "description"=>"Should the full model definition be included in the results. These definitions can be large. So be cautious when including them. Defaults to false.", "default"=>false, "deprecated"=>true},
              "decompress_definition" => {"type"=>"boolean", "default"=>true, "description"=>"Should the model definition be decompressed into valid JSON or returned in a custom compressed format. Defaults to true."},
              "from" => {"type"=>"int", "description"=>"skips a number of trained models", "default"=>0},
              "size" => {"type"=>"int", "description"=>"specifies a max number of trained models to get", "default"=>100},
              "tags" => {"type"=>"list", "description"=>"A comma-separated list of tags that the model must have."},
              "exclude_generated" => {"type"=>"boolean", "default"=>false, "description"=>"Omits fields that are illegal to set on model PUT"},
            }
          }
        ),
        "ml.get_trained_models_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-trained-models-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "ml.infer_trained_model" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/infer-trained-model.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "description"=>"Controls the amount of time to wait for inference results.", "default"=>"10s"},
            }
          }
        ),
        "ml.info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-ml-info.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_ml/info",
        ...
        "ml.open_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-open-job.html",
          methods: ["POST"],
          body: {"description"=>"Query parameters can be specified in the body", "required"=>false},
          url: {
        ...
        "ml.post_calendar_events" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-post-calendar-event.html",
          methods: ["POST"],
        ...
        "ml.post_data" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-post-data.html",
          methods: ["POST"],
        ...
        "ml.preview_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/preview-dfanalytics.html",
          methods: ["GET", "POST"],
        ...
        "ml.preview_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-preview-datafeed.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "start" => {"type"=>"string", "description"=>"The start time from where the datafeed preview should begin"},
              "end" => {"type"=>"string", "description"=>"The end time when the datafeed preview should stop"},
            }
          }
        ),
        "ml.put_calendar" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-put-calendar.html",
          methods: ["PUT"],
        ...
        "ml.put_calendar_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-put-calendar-job.html",
          methods: ["PUT"],
          body: nil,
          url: {
            path: "/_ml/calendars/{calendar_id}/jobs/{job_id}",
        ...
        "ml.put_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-dfanalytics.html",
          methods: ["PUT"],
        ...
        "ml.put_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-put-datafeed.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Ignore unavailable indexes (default: false)"},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Ignore if the source indices expressions resolves to no concrete indices (default: true)"},
              "ignore_throttled" => {"type"=>"boolean", "default"=>true, "description"=>"Ignore indices that are marked as throttled (default: true)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether source index expressions should get expanded to open or closed indices (default: open)"},
            }
          }
        ),
        "ml.put_filter" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-put-filter.html",
          methods: ["PUT"],
        ...
        "ml.put_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-put-job.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Ignore unavailable indexes (default: false). Only set if datafeed_config is provided."},
              "allow_no_indices" => {"type"=>"boolean", "default"=>true, "description"=>"Ignore if the source indices expressions resolves to no concrete indices (default: true). Only set if datafeed_config is provided."},
              "ignore_throttled" => {"type"=>"boolean", "default"=>true, "description"=>"Ignore indices that are marked as throttled (default: true). Only set if datafeed_config is provided."},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether source index expressions should get expanded to open or closed indices (default: open). Only set if datafeed_config is provided."},
            }
          }
        ),
        "ml.put_trained_model" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-trained-models.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "defer_definition_decompression" => {"type"=>"boolean", "description"=>"If set to `true` and a `compressed_definition` is provided, the request defers definition decompression and skips relevant validations.", "default"=>false},
              "wait_for_completion" => {"type"=>"boolean", "description"=>"Whether to wait for all child operations(e.g. model download) to complete, before returning or not. Default to false", "default"=>false},
            }
          }
        ),
        "ml.put_trained_model_alias" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-trained-models-aliases.html",
          methods: ["PUT"],
          body: nil,
          url: {
            path: "/_ml/trained_models/{model_id}/model_aliases/{model_alias}",
            ...
            params: {
              "reassign" => {"type"=>"boolean", "default"=>false, "description"=>"If the model_alias already exists and points to a separate model_id, this parameter must be true. Defaults to false."},
            }
          }
        ),
        "ml.put_trained_model_definition_part" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-trained-model-definition-part.html",
          methods: ["PUT"],
        ...
        "ml.put_trained_model_vocabulary" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-trained-model-vocabulary.html",
          methods: ["PUT"],
        ...
        "ml.reset_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-reset-job.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "ml.revert_model_snapshot" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-revert-snapshot.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "delete_intervening_results" => {"type"=>"boolean", "default"=>false, "description"=>"Should we reset the results back to the time of the snapshot?"},
            }
          }
        ),
        "ml.set_upgrade_mode" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-set-upgrade-mode.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "enabled" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to enable upgrade_mode ML setting or not. Defaults to false."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait before action times out. Defaults to 30 seconds"},
            }
          }
        ),
        "ml.start_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/start-dfanalytics.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"20s", "description"=>"Controls the time to wait until the task has started. Defaults to 20 seconds"},
            }
          }
        ),
        "ml.start_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-start-datafeed.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "start" => {"type"=>"string", "description"=>"The start time from where the datafeed should begin"},
              "end" => {"type"=>"string", "description"=>"The end time when the datafeed should stop. When not set, the datafeed continues in real time"},
              "timeout" => {"type"=>"time", "default"=>"20s", "description"=>"Controls the time to wait until a datafeed has started. Default to 20 seconds"},
            }
          }
        ),
        "ml.start_trained_model_deployment" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/start-trained-model-deployment.html",
          methods: ["POST"],
          body: {"description"=>"The settings for the trained model deployment", "required"=>false},
          url: {
            ...
            params: {
              "cache_size" => {"type"=>"string", "description"=>"A byte-size value for configuring the inference cache size. For example, 20mb."},
              "deployment_id" => {"type"=>"string", "description"=>"The Id of the new deployment. Defaults to the model_id if not set."},
              "number_of_allocations" => {"type"=>"int", "description"=>"The total number of allocations this model is assigned across machine learning nodes.", "default"=>1},
              "threads_per_allocation" => {"type"=>"int", "description"=>"The number of threads used by each model allocation during inference.", "default"=>1},
              "priority" => {"type"=>"string", "description"=>"The deployment priority.", "default"=>"normal"},
              "queue_capacity" => {"type"=>"int", "description"=>"Controls how many inference requests are allowed in the queue at a time.", "default"=>1024},
              "timeout" => {"type"=>"time", "description"=>"Controls the amount of time to wait for the model to deploy.", "default"=>"20s"},
              "wait_for" => {"type"=>"string", "description"=>"The allocation status for which to wait", "options"=>["starting", "started", "fully_allocated"], "default"=>"started"},
            }
          }
        ),
        "ml.stop_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/stop-dfanalytics.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no data frame analytics. (This includes `_all` string or when no data frame analytics have been specified)"},
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"True if the data frame analytics should be forcefully stopped"},
              "timeout" => {"type"=>"time", "default"=>"20s", "description"=>"Controls the time to wait until the task has stopped. Defaults to 20 seconds"},
            }
          }
        ),
        "ml.stop_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-stop-datafeed.html",
          methods: ["POST"],
          body: {"description"=>"The URL params optionally sent in the body", "required"=>false},
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no datafeeds. (This includes `_all` string or when no datafeeds have been specified)"},
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"True if the datafeed should be forcefully stopped."},
              "timeout" => {"type"=>"time", "default"=>"20s", "description"=>"Controls the time to wait until a datafeed has stopped. Default to 20 seconds"},
            }
          }
        ),
        "ml.stop_trained_model_deployment" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/stop-trained-model-deployment.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no deployments. (This includes `_all` string or when no deployments have been specified)"},
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"True if the deployment should be forcefully stopped"},
            }
          }
        ),
        "ml.update_data_frame_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ml-update-data-frame-analytics",
          methods: ["POST"],
        ...
        "ml.update_datafeed" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-update-datafeed.html",
          methods: ["POST"],
        ...
        "ml.update_filter" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-update-filter.html",
          methods: ["POST"],
        ...
        "ml.update_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-update-job.html",
          methods: ["POST"],
        ...
        "ml.update_model_snapshot" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-update-snapshot.html",
          methods: ["POST"],
        ...
        "ml.update_trained_model_deployment" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ml-update-trained-model-deployment",
          methods: ["POST"],
          body: {"description"=>"The updated trained model deployment settings", "required"=>false},
          url: {
            ...
            params: {
              "number_of_allocations" => {"type"=>"int", "default"=>1, "description"=>"Update the model deployment to this number of allocations."},
            }
          }
        ),
        "ml.upgrade_job_snapshot" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/ml-upgrade-job-model-snapshot.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30m", "description"=>"How long should the API wait for the job to be opened and the old snapshot to be loaded."},
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"Should the request wait until the task is complete before responding to the caller. Default is false."},
            }
          }
        ),
        ...
        "ml.validate_detector" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8",
          methods: ["POST"],
        ...
        "msearch" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-multi-search.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "index" => {"type"=>"list", "description"=>"A comma-separated list of index names to use as default"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "ignore_throttled" => {"type"=>"boolean", "deprecated"=>true, "default"=>false, "description"=>"Whether specified concrete, expanded or aliased indices should be ignored when throttled"},
              "allow_no_indices" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
              "expand_wildcards" => {"type"=>"enum", "options"=>["open", "closed", "hidden", "none", "all"], "default"=>"open", "description"=>"Whether to expand wildcard expression to concrete indices that are open, closed or both."},
              "routing" => {"type"=>"list", "description"=>"A comma-separated list of specific routing values"},
        ...
        "msearch_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/multi-search-template.html",
          methods: ["GET", "POST"],
          body: {"description"=>"The request definitions (metadata-search request definition pairs), separated by newlines", "required"=>true, "serialize"=>"bulk"},
          url: {
            ...
            params: {
              "search_type" => {"type"=>"enum", "options"=>["query_then_fetch", "dfs_query_then_fetch"], "description"=>"Search operation type"},
              "typed_keys" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether aggregation and suggester names should be prefixed by their respective types in the response"},
              "max_concurrent_searches" => {"type"=>"number", "description"=>"Controls the maximum number of concurrent searches the multi search api will execute"},
              "rest_total_hits_as_int" => {"type"=>"boolean", "description"=>"Indicates whether hits.total should be rendered as an integer or an object in the rest search response", "default"=>false},
              "ccs_minimize_roundtrips" => {"type"=>"boolean", "description"=>"Indicates whether network round-trips should be minimized as part of cross-cluster search requests execution", "default"=>"true"},
            }
        ...
        "mtermvectors" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-multi-termvectors.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "realtime" => {"type"=>"boolean", "default"=>true, "description"=>"Specifies if requests are real-time as opposed to near-real-time (default: true)."},
              "version" => {"type"=>"number", "description"=>"Explicit version number for concurrency control"},
              "version_type" => {"type"=>"enum", "options"=>["internal", "external", "external_gte"], "description"=>"Specific version type"},
            }
          }
        ...
        "nodes.clear_repositories_metering_archive" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clear-repositories-metering-archive-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "nodes.get_repositories_metering_info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-repositories-metering-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "nodes.hot_threads" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-hot-threads.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "interval" => {"type"=>"time", "default"=>"500ms", "description"=>"The interval for the second sampling of threads"},
              "snapshots" => {"type"=>"number", "default"=>10, "description"=>"Number of samples of thread stacktrace (default: 10)"},
              "threads" => {"type"=>"number", "default"=>3, "description"=>"Specify the number of threads to provide information for (default: 3)"},
              "ignore_idle_threads" => {"type"=>"boolean", "default"=>true, "description"=>"Don't show threads that are in known-idle places, such as waiting on a socket select or pulling from an empty task queue (default: true)"},
              "type" => {"type"=>"enum", "options"=>["cpu", "wait", "block", "mem"], "default"=>"cpu", "description"=>"The type to sample (default: cpu)"},
        ...
        "nodes.info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-info.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_nodes",
        ...
        "nodes.reload_secure_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-reload-secure-settings.html",
          methods: ["POST"],
        ...
        "nodes.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_nodes/stats",
        ...
        "nodes.usage" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster-nodes-usage.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_nodes/usage",
        ...
        "open_point_in_time" => RestApi.new(
          ...
          url: {
            ...
            params: {
              ...
              "allow_partial_search_results" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether to tolerate shards missing when creating the point-in-time, or otherwise throw an exception. (default: false)"},
              "max_concurrent_shard_requests" => {"type"=>"number", "description"=>"The number of concurrent shard requests per node executed concurrently when opening this point-in-time. This value should be used to limit the impact of opening the point-in-time on the cluster", "default"=>5},
            }
          }
        ),
        "ping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/cluster.html",
          methods: ["HEAD"],
          body: nil,
          url: {
            path: "/",
        ...
        "profiling.topn_functions" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/observability/current/universal-profiling.html",
          methods: ["POST"],
          body: {"description"=>"The filter conditions for stacktraces", "required"=>true},
          url: {
            path: "/_profiling/topn/functions",
            paths: ["/_profiling/topn/functions"],
          }
        ),
        "put_script" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-stored-script-api.html",
          methods: ["PUT", "POST"],
          body: {"description"=>"The document", "required"=>true},
          url: {
            path: "/_scripts/{id}",
        ...
        "query_rules.delete_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-query-rule.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_query_rules/{ruleset_id}/_rule/{rule_id}",
            paths: ["/_query_rules/{ruleset_id}/_rule/{rule_id}"],
            parts: {
              "ruleset_id" => {"type"=>"string", "description"=>"The unique identifier of the query ruleset this rule exists in"},
              "rule_id" => {"type"=>"string", "description"=>"The unique identifier of the rule to delete."},
            },
          }
        ),
        "query_rules.delete_ruleset" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-query-ruleset.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "query_rules.get_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-query-rule.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_query_rules/{ruleset_id}/_rule/{rule_id}",
            paths: ["/_query_rules/{ruleset_id}/_rule/{rule_id}"],
            parts: {
              "ruleset_id" => {"type"=>"string", "description"=>"The unique identifier of the query ruleset the rule exists within"},
              "rule_id" => {"type"=>"string", "description"=>"The unique identifier of the rule to be retrieved."},
            },
          }
        ),
        "query_rules.get_ruleset" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-query-ruleset.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_query_rules/{ruleset_id}",
        ...
        "query_rules.list_rulesets" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/list-query-rulesets.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_query_rules",
        ...
        "query_rules.put_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-query-rule.html",
          methods: ["PUT"],
          body: {"description"=>"The query rule configuration, including the type of rule, the criteria to match the rule, and the action that should be taken if the rule matches.", "required"=>true},
          url: {
            path: "/_query_rules/{ruleset_id}/_rule/{rule_id}",
            paths: ["/_query_rules/{ruleset_id}/_rule/{rule_id}"],
            parts: {
              "ruleset_id" => {"type"=>"string", "description"=>"The unique identifier of the ruleset this rule should be added to. The ruleset will be created if it does not exist."},
              "rule_id" => {"type"=>"string", "description"=>"The unique identifier of the rule to be created or updated."},
            },
          }
        ),
        "query_rules.put_ruleset" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-query-ruleset.html",
          methods: ["PUT"],
        ...
        "query_rules.test" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/test-query-ruleset.html",
          methods: ["POST"],
          body: {"description"=>"The match criteria to test against the ruleset", "required"=>true},
          url: {
            path: "/_query_rules/{ruleset_id}/_test",
            paths: ["/_query_rules/{ruleset_id}/_test"],
            parts: {
              "ruleset_id" => {"type"=>"string", "description"=>"The unique identifier of the ruleset to test."},
            },
          }
        ),
        "rank_eval" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-rank-eval.html",
          methods: ["GET", "POST"],
        ...
        "reindex" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-reindex.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "requests_per_second" => {"type"=>"number", "default"=>-1, "description"=>"The throttle to set on this request in sub-requests per second. -1 means no throttle."},
              "scroll" => {"type"=>"time", "description"=>"Control how long to keep the search context alive", "default"=>"5m"},
              "slices" => {"type"=>"number|string", "default"=>1, "description"=>"The number of slices this task should be divided into. Defaults to 1, meaning the task isn't sliced into subtasks. Can be set to `auto`."},
              "max_docs" => {"type"=>"number", "description"=>"Maximum number of documents to process (default: all documents)"},
              "require_alias" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires destination to be an alias."},
            }
          }
        ),
        ...
        "render_search_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/render-search-template-api.html",
          methods: ["GET", "POST"],
        ...
        "rollup.delete_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-delete-job.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_rollup/job/{id}",
        ...
        "rollup.get_jobs" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-get-job.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_rollup/job/{id}",
        ...
        "rollup.get_rollup_caps" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-get-rollup-caps.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "rollup.get_rollup_index_caps" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-get-rollup-index-caps.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "rollup.put_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-put-job.html",
          methods: ["PUT"],
        ...
        "rollup.rollup_search" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-search.html",
          methods: ["GET", "POST"],
        ...
        "rollup.start_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-start-job.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "rollup.stop_job" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/rollup-stop-job.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"True if the API should block until the job has fully stopped, false if should be executed async. Defaults to false."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Block for (at maximum) the specified duration while waiting for the job to stop.  Defaults to 30s."},
            }
          }
        ),
        "scripts_painless_execute" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/painless/8.19/painless-execute-api.html",
          methods: ["GET", "POST"],
        ...
        "scroll" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/scroll-api.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "scroll" => {"type"=>"time", "default"=>"1d", "description"=>"Specify how long a consistent view of the index should be maintained for scrolled search"},
        ...
        "search" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-search.html",
          methods: ["GET", "POST"],
          body: {"description"=>"The search definition using the Query DSL"},
          url: {
            path: "/_search",
            ...
            params: {
              ...
              "default_operator" => {"type"=>"enum", "options"=>["AND", "OR"], "default"=>"OR", "description"=>"The default operator for query string query (AND or OR)"},
              "df" => {"type"=>"string", "description"=>"The field to use as default where no field prefix is given in the query string"},
              "explain" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether to return detailed information about score computation as part of a hit"},
              "stored_fields" => {"type"=>"list", "description"=>"A comma-separated list of stored fields to return as part of a hit"},
              "docvalue_fields" => {"type"=>"list", "description"=>"A comma-separated list of fields to return as the docvalue representation of a field for each hit"},
              "from" => {"type"=>"number", "default"=>0, "description"=>"Starting offset (default: 0)"},
              "force_synthetic_source" => {"type"=>"boolean", "description"=>"Should this request force synthetic _source? Use this to test if the mapping supports synthetic _source and to get a sense of the worst case performance. Fetches with this enabled will be slower the enabling synthetic source natively in the index.", "visibility"=>"feature_flag", "feature_flag"=>"es.index_mode_feature_flag_registered"},
              ...
              "scroll" => {"type"=>"time", "description"=>"Specify how long a consistent view of the index should be maintained for scrolled search"},
              "search_type" => {"type"=>"enum", "options"=>["query_then_fetch", "dfs_query_then_fetch"], "description"=>"Search operation type"},
              "size" => {"type"=>"number", "default"=>10, "description"=>"Number of hits to return (default: 10)"},
              "sort" => {"type"=>"list", "description"=>"A comma-separated list of <field>:<direction> pairs"},
              "_source" => {"type"=>"list", "default"=>"true", "description"=>"True or false to return the _source field or not, or a list of fields to return"},
              "_source_excludes" => {"type"=>"list", "description"=>"A list of fields to exclude from the returned _source field"},
              "_source_includes" => {"type"=>"list", "description"=>"A list of fields to extract and return from the _source field"},
              "terminate_after" => {"type"=>"number", "default"=>0, "description"=>"The maximum number of documents to collect for each shard, upon reaching which the query execution will terminate early."},
              "stats" => {"type"=>"list", "description"=>"Specific 'tag' of the request for logging and statistical purposes"},
              "suggest_field" => {"type"=>"string", "description"=>"Specify which field to use for suggestions"},
              "suggest_mode" => {"type"=>"enum", "options"=>["missing", "popular", "always"], "default"=>"missing", "description"=>"Specify suggest mode"},
              "suggest_size" => {"type"=>"number", "description"=>"How many suggestions to return in response"},
              "suggest_text" => {"type"=>"string", "description"=>"The source text for which the suggestions should be returned"},
              "timeout" => {"type"=>"time", "description"=>"Explicit operation timeout"},
              "track_scores" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to calculate and return scores even if they are not used for sorting"},
              "track_total_hits" => {"type"=>"boolean|long", "default"=>"10000", "description"=>"Indicate if the number of documents that match the query should be tracked. A number can also be specified, to accurately track the total hit count up to the number."},
              "allow_partial_search_results" => {"type"=>"boolean", "default"=>true, "description"=>"Indicate if an error should be returned if there is a partial search failure or timeout"},
              "typed_keys" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether aggregation and suggester names should be prefixed by their respective types in the response"},
              "version" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether to return document version as part of a hit"},
              "seq_no_primary_term" => {"type"=>"boolean", "description"=>"Specify whether to return sequence number and primary term of the last modification of each hit"},
              "request_cache" => {"type"=>"boolean", "description"=>"Specify if request cache should be used for this request or not, defaults to index level setting"},
        ...
        "search_application.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-search-application.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "search_application.delete_behavioral_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-analytics-collection.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "search_application.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-search-application.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_application/search_application/{name}",
        ...
        "search_application.get_behavioral_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/list-analytics-collection.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "search_application.post_behavioral_analytics_event" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/post-analytics-collection-event.html",
          methods: ["POST"],
        ...
        "search_application.put" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-search-application.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "create" => {"type"=>"boolean", "default"=>false, "description"=>"If true, requires that a search application with the specified resource_id does not already exist. (default: false)"},
            }
          }
        ),
        "search_application.put_behavioral_analytics" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-analytics-collection.html",
          methods: ["PUT"],
          body: nil,
          url: {
            path: "/_application/analytics/{name}",
        ...
        "search_application.render_query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-application-render-query.html",
          methods: ["POST"],
        ...
        "search_application.search" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-application-search.html",
          methods: ["GET", "POST"],
        ...
        "search_mvt" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-vector-tile-api.html",
          methods: ["POST", "GET"],
          ...
          url: {
            ...
            params: {
              ...
              "grid_agg" => {"type"=>"enum", "options"=>["geotile", "geohex"], "description"=>"Aggregation used to create a grid for `field`.", "default"=>"geotile"},
        ...
        "search_shards" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-shards.html",
          methods: ["GET", "POST"],
          body: nil,
          url: {
            path: "/_search_shards",
        ...
        "search_template" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-template-api.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "search_type" => {"type"=>"enum", "options"=>["query_then_fetch", "dfs_query_then_fetch"], "description"=>"Search operation type"},
              "explain" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether to return detailed information about score computation as part of a hit"},
              "profile" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether to profile the query execution"},
              "typed_keys" => {"type"=>"boolean", "default"=>false, "description"=>"Specify whether aggregation and suggester names should be prefixed by their respective types in the response"},
              "rest_total_hits_as_int" => {"type"=>"boolean", "description"=>"Indicates whether hits.total should be rendered as an integer or an object in the rest search response", "default"=>false},
              "ccs_minimize_roundtrips" => {"type"=>"boolean", "description"=>"Indicates whether network round-trips should be minimized as part of cross-cluster search requests execution", "default"=>"true"},
            }
        ...
        "searchable_snapshots.cache_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/searchable-snapshots-api-cache-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "searchable_snapshots.clear_cache" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/searchable-snapshots-api-clear-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            parts: {
              "index" => {"type"=>"list", "description"=>"Clear the cache"},
            },
            params: {
              "ignore_unavailable" => {"type"=>"boolean", "description"=>"Whether specified concrete indices should be ignored when unavailable (missing or closed)"},
              "allow_no_indices" => {"type"=>"boolean", "description"=>"Whether to ignore if a wildcard indices expression resolves into no concrete indices. (This includes `_all` string or when no indices have been specified)"},
        ...
        "searchable_snapshots.mount" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/searchable-snapshots-api-mount-snapshot.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "storage" => {"type"=>"string", "description"=>"Selects the kind of local storage used to accelerate searches. Experimental, and defaults to `full_copy`", "default"=>"full_copy"},
            }
          }
        ),
        "searchable_snapshots.stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/searchable-snapshots-api-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.activate_user_profile" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-activate-user-profile.html",
          methods: ["POST"],
        ...
        "security.authenticate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-authenticate.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.bulk_delete_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-bulk-delete-role.html",
          methods: ["DELETE"],
          body: {"description"=>"The roles to delete", "required"=>true},
          url: {
            path: "/_security/role",
            paths: ["/_security/role"],
            params: {
        ...
        "security.bulk_put_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-bulk-put-role.html",
          methods: ["POST"],
          body: {"description"=>"The roles to add", "required"=>true},
          url: {
            path: "/_security/role",
            paths: ["/_security/role"],
            params: {
        ...
        "security.bulk_update_api_keys" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-bulk-update-api-keys.html",
          methods: ["POST"],
        ...
        "security.change_password" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-change-password.html",
          methods: ["PUT", "POST"],
        ...
        "security.clear_api_key_cache" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-clear-api-key-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "security.clear_cached_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-clear-privilege-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "security.clear_cached_realms" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-clear-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "usernames" => {"type"=>"list", "description"=>"Comma-separated list of usernames to clear from the cache"},
            }
          }
        ),
        "security.clear_cached_roles" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-clear-role-cache.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "security.clear_cached_service_tokens" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-clear-service-token-caches.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "security.create_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-create-api-key.html",
          methods: ["PUT", "POST"],
        ...
        "security.create_cross_cluster_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-create-cross-cluster-api-key.html",
          methods: ["POST"],
        ...
        "security.create_service_token" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-create-service-token.html",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "security.delegate_pki" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delegate-pki-authentication.html",
          methods: ["POST"],
          body: {"description"=>"The X509Certificate chain.", "required"=>true},
          url: {
            path: "/_security/delegate_pki",
            paths: ["/_security/delegate_pki"],
          }
        ),
        "security.delete_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delete-privilege.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "security.delete_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delete-role.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "security.delete_role_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delete-role-mapping.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "security.delete_service_token" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delete-service-token.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_security/service/{namespace}/{service}/credential/token/{name}",
        ...
        "security.delete_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-delete-user.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "security.disable_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-disable-user.html",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "security.disable_user_profile" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-disable-user-profile.html",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
            ...
            params: {
              "refresh" => {"type"=>"enum", "options"=>["true", "false", "wait_for"], "default"=>"false", "description"=>"If `true` then refresh the affected shards to make this operation visible to search, if `wait_for` (the default) then wait for a refresh to make this operation visible to search, if `false` then do nothing with refreshes."},
            }
          }
        ),
        "security.enable_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-enable-user.html",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "security.enable_user_profile" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-enable-user-profile.html",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "security.enroll_kibana" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-kibana-enrollment.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.enroll_node" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-node-enrollment.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-api-key.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_security/api_key",
            ...
            params: {
              ...
              "with_profile_uid" => {"type"=>"boolean", "default"=>false, "description"=>"flag to also retrieve the API Key's owner profile uid, if it exists"},
        ...
        "security.get_builtin_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-builtin-privileges.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-privileges.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-role.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_security/role/{name}",
        ...
        "security.get_role_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-role-mapping.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_security/role_mapping/{name}",
        ...
        "security.get_service_accounts" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-service-accounts.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_service_credentials" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-service-credentials.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-settings.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Timeout for connection to master"},
            }
          }
        ),
        "security.get_token" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-token.html",
          methods: ["POST"],
        ...
        "security.get_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-user.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_security/user/{username}",
        ...
        "security.get_user_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-user-privileges.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.get_user_profile" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-get-user-profile.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.grant_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-grant-api-key.html",
          methods: ["POST"],
          body: {"description"=>"The api key request to create an API key", "required"=>true},
          url: {
            ...
            params: {
              "refresh" => {"type"=>"enum", "options"=>["true", "false", "wait_for"], "default"=>"false", "description"=>"If `true` (the default) then refresh the affected shards to make this operation visible to search, if `wait_for` then wait for a refresh to make this operation visible to search, if `false` then do nothing with refreshes."},
            }
          }
        ),
        "security.has_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-has-privileges.html",
          methods: ["GET", "POST"],
        ...
        "security.has_privileges_user_profile" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-has-privileges-user-profile.html",
          methods: ["GET", "POST"],
        ...
        "security.invalidate_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-invalidate-api-key.html",
          methods: ["DELETE"],
        ...
        "security.invalidate_token" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-invalidate-token.html",
          methods: ["DELETE"],
        ...
        "security.oidc_authenticate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-oidc-authenticate.html",
          methods: ["POST"],
        ...
        "security.oidc_logout" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-oidc-logout.html",
          methods: ["POST"],
        ...
        "security.oidc_prepare_authentication" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-oidc-prepare-authentication.html",
          methods: ["POST"],
        ...
        "security.put_privileges" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-put-privileges.html",
          methods: ["PUT", "POST"],
        ...
        "security.put_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-put-role.html",
          methods: ["PUT", "POST"],
        ...
        "security.put_role_mapping" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-put-role-mapping.html",
          methods: ["PUT", "POST"],
        ...
        "security.put_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-put-user.html",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            params: {
              "refresh" => {"type"=>"enum", "options"=>["true", "false", "wait_for"], "default"=>"true", "description"=>"If `true` (the default) then refresh the affected shards to make this operation visible to search, if `wait_for` then wait for a refresh to make this operation visible to search, if `false` then do nothing with refreshes."},
            }
          }
        ),
        "security.query_api_keys" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-query-api-key.html",
          methods: ["GET", "POST"],
        ...
        "security.query_role" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-query-role.html",
          methods: ["GET", "POST"],
          body: {"description"=>"From, size, query, sort and search_after", "required"=>false},
          url: {
            path: "/_security/_query/role",
            paths: ["/_security/_query/role"],
          }
        ),
        "security.query_user" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-query-user.html",
          methods: ["GET", "POST"],
          body: {"description"=>"From, size, query, sort and search_after", "required"=>false},
          url: {
        ...
        "security.saml_authenticate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-authenticate.html",
          methods: ["POST"],
        ...
        "security.saml_complete_logout" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-complete-logout.html",
          methods: ["POST"],
        ...
        "security.saml_invalidate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-invalidate.html",
          methods: ["POST"],
        ...
        "security.saml_logout" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-logout.html",
          methods: ["POST"],
        ...
        "security.saml_prepare_authentication" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-prepare-authentication.html",
          methods: ["POST"],
        ...
        "security.saml_service_provider_metadata" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-saml-sp-metadata.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "security.suggest_user_profiles" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-suggest-user-profile.html",
          methods: ["GET", "POST"],
        ...
        "security.update_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-update-api-key.html",
          methods: ["PUT"],
        ...
        "security.update_cross_cluster_api_key" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-update-cross-cluster-api-key.html",
          methods: ["PUT"],
        ...
        "security.update_settings" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-update-settings.html",
          methods: ["PUT"],
        ...
        "security.update_user_profile_data" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-update-user-profile-data.html",
          methods: ["PUT", "POST"],
        ...
        "shutdown.delete_node" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-shutdown.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "shutdown.get_node" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-shutdown.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "shutdown.put_node" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-shutdown.html",
          methods: ["PUT"],
        ...
        "simulate.ingest" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/simulate-ingest-api.html",
          methods: ["GET", "POST"],
          body: {"description"=>"The simulate definition", "required"=>true},
          url: {
        ...
        "slm.delete_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-delete-policy.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "slm.execute_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-execute-lifecycle.html",
          methods: ["PUT"],
          body: nil,
          url: {
        ...
        "slm.execute_retention" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-execute-retention.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "slm.get_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-get-policy.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_slm/policy/{policy_id}",
        ...
        "slm.get_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-get-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_slm/stats",
        ...
        "slm.get_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-get-status.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_slm/status",
        ...
        "slm.put_lifecycle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-put-policy.html",
          methods: ["PUT"],
        ...
        "slm.start" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-start.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_slm/start",
        ...
        "slm.stop" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/slm-api-stop.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_slm/stop",
        ...
        "snapshot.cleanup_repository" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clean-up-snapshot-repo-api.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "snapshot.clone" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clone-snapshot-api.html",
          methods: ["PUT"],
        ...
        "snapshot.create" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/create-snapshot-api.html",
          methods: ["PUT", "POST"],
        ...
        "snapshot.create_repository" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-snapshot-repo-api.html",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
              "verify" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to verify the repository after creation"},
            }
          }
        ),
        "snapshot.delete" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_snapshot/{repository}/{snapshot}",
        ...
        "snapshot.delete_repository" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-snapshot-repo-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_snapshot/{repository}",
        ...
        "snapshot.get" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_snapshot/{repository}/{snapshot}",
            ...
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout for connection to master node"},
              "ignore_unavailable" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to ignore unavailable snapshots, defaults to false which means a SnapshotMissingException is thrown"},
              "index_names" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to include the name of each index in the snapshot. Defaults to true."},
              "index_details" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to include details of each index in the snapshot, if those details are available. Defaults to false."},
              "include_repository" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to include the repository name in the snapshot info. Defaults to true."},
              ...
              "size" => {"type"=>"integer", "default"=>0, "description"=>"Maximum number of snapshots to return. Defaults to 0 which means return all that match without limit."},
              ...
              "offset" => {"type"=>"integer", "default"=>0, "description"=>"Numeric offset to start pagination based on the snapshots matching the request. Defaults to 0"},
              ...
              "verbose" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to show verbose snapshot info or only show the basic info found in the repository index blob"},
            }
          }
        ),
        "snapshot.get_repository" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-repo-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_snapshot",
        ...
        "snapshot.repository_analyze" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/repo-analysis-api.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "blob_count" => {"type"=>"number", "default"=>100, "description"=>"Number of blobs to create during the test. Defaults to 100."},
              "concurrency" => {"type"=>"number", "default"=>10, "description"=>"Number of operations to run concurrently during the test. Defaults to 10."},
              "register_operation_count" => {"type"=>"number", "default"=>10, "description"=>"The minimum number of linearizable register operations to perform in total. Defaults to 10."},
              "read_node_count" => {"type"=>"number", "default"=>10, "description"=>"Number of nodes on which to read a blob after writing. Defaults to 10."},
              "early_read_node_count" => {"type"=>"number", "default"=>2, "description"=>"Number of nodes on which to perform an early read on a blob, i.e. before writing has completed. Early reads are rare actions so the 'rare_action_probability' parameter is also relevant. Defaults to 2."},
              ...
              "rare_action_probability" => {"type"=>"number", "default"=>0, "description"=>"Probability of taking a rare action such as an early read or an overwrite. Defaults to 0.02."},
              "max_blob_size" => {"type"=>"string", "default"=>"10mb", "description"=>"Maximum size of a blob to create during the test, e.g '1gb' or '100mb'. Defaults to '10mb'."},
              "max_total_data_size" => {"type"=>"string", "default"=>"1gb", "description"=>"Maximum total size of all blobs to create during the test, e.g '1tb' or '100gb'. Defaults to '1gb'."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout. Defaults to '30s'."},
              "detailed" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to return detailed results or a summary. Defaults to 'false' so that only the summary is returned."},
              "rarely_abort_writes" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to rarely abort writes before they complete. Defaults to 'true'."},
            }
          }
        ),
        "snapshot.repository_verify_integrity" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-repo-integrity-api.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_snapshot/{repository}/_verify_integrity",
            paths: ["/_snapshot/{repository}/_verify_integrity"],
            parts: {
              "repository" => {"type"=>"string", "description"=>"A repository name"},
            },
            params: {
              "meta_thread_pool_concurrency" => {"type"=>"number", "default"=>0, "description"=>"Number of threads to use for reading metadata"},
              "blob_thread_pool_concurrency" => {"type"=>"number", "default"=>1, "description"=>"Number of threads to use for reading blob contents"},
              "snapshot_verification_concurrency" => {"type"=>"number", "default"=>0, "description"=>"Number of snapshots to verify concurrently"},
              "index_verification_concurrency" => {"type"=>"number", "default"=>0, "description"=>"Number of indices to verify concurrently"},
              "index_snapshot_verification_concurrency" => {"type"=>"number", "default"=>1, "description"=>"Number of snapshots to verify concurrently within each index"},
              "max_failed_shard_snapshots" => {"type"=>"number", "default"=>10000, "description"=>"Maximum permitted number of failed shard snapshots"},
              "verify_blob_contents" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to verify the contents of individual blobs"},
              "max_bytes_per_sec" => {"type"=>"string", "default"=>"10mb", "description"=>"Rate limit for individual blob verification"},
            }
          }
        ),
        "snapshot.restore" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/restore-snapshot-api.html",
          methods: ["POST"],
        ...
        "snapshot.status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-snapshot-status-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "snapshot.verify_repository" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/verify-snapshot-repo-api.html",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "sql.clear_cursor" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/clear-sql-cursor-api.html",
          methods: ["POST"],
        ...
        "sql.delete_async" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-async-sql-search-api.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "sql.get_async" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-sql-search-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_sql/async/{id}",
        ...
        "sql.get_async_status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-sql-search-status-api.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "sql.query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/sql-search-api.html",
          methods: ["POST", "GET"],
        ...
        "sql.translate" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/sql-translate-api.html",
          methods: ["POST", "GET"],
        ...
        "ssl.certificates" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/security-api-ssl.html",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "streams.logs_disable" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_streams/logs/_disable"],
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a response. If no response is received before the timeout expires, the request fails and returns an error."},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a connection to the master node. If no response is received before the timeout expires, the request fails and returns an error."},
            }
          }
        ),
        "streams.logs_enable" => RestApi.new(
        ...
        "streams.status" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/master/streams-status.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_streams/status",
            paths: ["/_streams/status"],
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Period to wait for a response. If no response is received before the timeout expires, the request fails and returns an error."},
            }
          }
        ),
        "synonyms.delete_synonym" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-synonyms-set.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            path: "/_synonyms/{id}",
        ...
        "synonyms.delete_synonym_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-synonym-rule.html",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "synonyms.get_synonym" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-synonyms-set.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_synonyms/{id}",
        ...
        "synonyms.get_synonym_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-synonym-rule.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_synonyms/{set_id}/{rule_id}",
        ...
        "synonyms.put_synonym" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-synonyms-set.html",
          methods: ["PUT"],
        ...
        "synonyms.put_synonym_rule" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-synonym-rule.html",
          methods: ["PUT"],
        ...
        "tasks.cancel" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/tasks.html",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_tasks/_cancel",
            ...
            params: {
              ...
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"Should the request block until the cancellation of the task and its descendant tasks is completed. Defaults to false"},
            }
          }
        ),
        "tasks.get" => RestApi.new(
          ...
          url: {
            ...
            params: {
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"Wait for the matching tasks to complete (default: false)"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Explicit operation timeout"},
            }
          }
        ),
        ...
        "terms_enum" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/search-terms-enum.html",
          methods: ["GET", "POST"],
        ...
        "termvectors" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-termvectors.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              ...
              "preference" => {"type"=>"string", "description"=>"Specify the node or shard the operation should be performed on (default: random)."},
              "routing" => {"type"=>"string", "description"=>"Specific routing value."},
              "realtime" => {"type"=>"boolean", "default"=>true, "description"=>"Specifies if request is real-time as opposed to near-real-time (default: true)."},
              "version" => {"type"=>"number", "description"=>"Explicit version number for concurrency control"},
              "version_type" => {"type"=>"enum", "options"=>["internal", "external", "external_gte"], "description"=>"Specific version type"},
            }
          }
        ),
        "text_structure.find_field_structure" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/find-field-structure.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_text_structure/find_field_structure",
            paths: ["/_text_structure/find_field_structure"],
            params: {
              "index" => {"type"=>"string", "description"=>"The index containing the analyzed field", "required"=>true},
              "field" => {"type"=>"string", "description"=>"The field that should be analyzed", "required"=>true},
              "documents_to_sample" => {"type"=>"int", "description"=>"How many documents should be included in the analysis", "default"=>1000},
              ...
              "ecs_compatibility" => {"type"=>"string", "default"=>"disabled", "description"=>"Optional parameter to specify the compatibility mode with ECS Grok patterns - may be either 'v1' or 'disabled'"},
        ...
        "text_structure.find_message_structure" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/find-message-structure.html",
          methods: ["GET", "POST"],
          body: {"description"=>"JSON object with one field [messages], containing an array of messages to be analyzed", "required"=>true},
          url: {
            path: "/_text_structure/find_message_structure",
            paths: ["/_text_structure/find_message_structure"],
            params: {
              "timeout" => {"type"=>"time", "description"=>"Timeout after which the analysis will be aborted", "default"=>"25s"},
              "format" => {"type"=>"enum", "options"=>["ndjson", "xml", "delimited", "semi_structured_text"], "description"=>"Optional parameter to specify the high level file format"},
              "column_names" => {"type"=>"list", "description"=>"Optional parameter containing a comma separated list of the column names for a delimited file"},
        ...
        "text_structure.find_structure" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/find-structure.html",
          methods: ["POST"],
        ...
        "text_structure.test_grok_pattern" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/test-grok-pattern.html",
          methods: ["GET", "POST"],
        ...
        "transform.delete_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/delete-transform.html",
          methods: ["DELETE"],
          body: nil,
          url: {
            ...
            params: {
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"When `true`, the transform is deleted regardless of its current state. The default value is `false`, meaning that the transform must be `stopped` before it can be deleted."},
              "delete_dest_index" => {"type"=>"boolean", "default"=>false, "description"=>"When `true`, the destination index is deleted together with the transform. The default value is `false`, meaning that the destination index will not be deleted."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the transform deletion"},
            }
          }
        ),
        "transform.get_node_stats" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_transform/_node_stats"],
          }
        ),
        "transform.get_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-transform.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_transform/{transform_id}",
            ...
            params: {
              ...
              "size" => {"type"=>"int", "default"=>100, "description"=>"specifies a max number of transforms to get, defaults to 100"},
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no transforms. (This includes `_all` string or when no transforms have been specified)"},
              "exclude_generated" => {"type"=>"boolean", "default"=>false, "description"=>"Omits fields that are illegal to set on transform PUT"},
            }
          }
        ),
        "transform.get_transform_stats" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-transform-stats.html",
          methods: ["GET"],
          body: nil,
          url: {
            ...
            params: {
              "from" => {"type"=>"number", "default"=>0, "description"=>"skips a number of transform stats, defaults to 0"},
              "size" => {"type"=>"number", "default"=>100, "description"=>"specifies a max number of transform stats to get, defaults to 100"},
              "timeout" => {"type"=>"time", "description"=>"Controls the time to wait for the stats"},
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no transforms. (This includes `_all` string or when no transforms have been specified)"},
            }
          }
        ),
        "transform.preview_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/preview-transform.html",
          methods: ["GET", "POST"],
          ...
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the preview"},
            }
          }
        ),
        "transform.put_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/put-transform.html",
          methods: ["PUT"],
          ...
          url: {
            ...
            params: {
              "defer_validation" => {"type"=>"boolean", "default"=>false, "description"=>"If validations should be deferred until transform starts, defaults to false."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the transform to start"},
            }
          }
        ),
        "transform.reset_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/reset-transform.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"When `true`, the transform is reset regardless of its current state. The default value is `false`, meaning that the transform must be `stopped` before it can be reset."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the transform to reset"},
            }
          }
        ),
        "transform.schedule_now_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/schedule-now-transform.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the scheduling to take place"},
            }
          }
        ),
        "transform.set_upgrade_mode" => RestApi.new(
          ...
          url: {
            ...
            paths: ["/_transform/set_upgrade_mode"],
            params: {
              "enabled" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to enable upgrade_mode Transform setting or not. Defaults to false."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait before action times out. Defaults to 30 seconds"},
            }
          }
        ),
        "transform.start_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/start-transform.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "from" => {"type"=>"string", "description"=>"Restricts the set of transformed entities to those changed after this time"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the transform to start"},
            }
          }
        ),
        "transform.stop_transform" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/stop-transform.html",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "force" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to force stop a failed transform or not. Default to false"},
              "wait_for_completion" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to wait for the transform to fully stop before returning or not. Default to false"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait until the transform has stopped. Default to 30 seconds"},
              "allow_no_match" => {"type"=>"boolean", "default"=>true, "description"=>"Whether to ignore if a wildcard expression matches no transforms. (This includes `_all` string or when no transforms have been specified)"},
              "wait_for_checkpoint" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to wait for the transform to reach a checkpoint before stopping. Default to false"},
            }
          }
        ),
        "transform.update_transform" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-transform-update-transform",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              "defer_validation" => {"type"=>"boolean", "description"=>"If validations should be deferred until transform starts, defaults to false."},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the update"},
            }
          }
        ),
        "transform.upgrade_transforms" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-transform-upgrade-transforms",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "dry_run" => {"type"=>"boolean", "default"=>false, "description"=>"Whether to only check for updates but don't execute"},
              "timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Controls the time to wait for the upgrade"},
            }
          }
        ),
        "update" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-update.html",
          methods: ["POST"],
          ...
          url: {
            ...
            params: {
              ...
              "_source_excludes" => {"type"=>"list", "description"=>"A list of fields to exclude from the returned _source field"},
              "_source_includes" => {"type"=>"list", "description"=>"A list of fields to extract and return from the _source field"},
              "lang" => {"type"=>"string", "default"=>"painless", "description"=>"The script language (default: painless)"},
              "refresh" => {"type"=>"enum", "options"=>["true", "false", "wait_for"], "default"=>"false", "description"=>"If `true` then refresh the affected shards to make this operation visible to search, if `wait_for` then wait for a refresh to make this operation visible to search, if `false` (the default) then do nothing with refreshes."},
              "retry_on_conflict" => {"type"=>"number", "default"=>0, "description"=>"Specify how many times should the operation be retried when a conflict occurs (default: 0)"},
              "routing" => {"type"=>"string", "description"=>"Specific routing value"},
              "timeout" => {"type"=>"time", "default"=>"1m", "description"=>"Explicit operation timeout"},
              "if_seq_no" => {"type"=>"number", "description"=>"only perform the update operation if the last operation that has changed the document has the specified sequence number"},
              "if_primary_term" => {"type"=>"number", "description"=>"only perform the update operation if the last operation that has changed the document has the specified primary term"},
              "require_alias" => {"type"=>"boolean", "default"=>false, "description"=>"When true, requires destination is an alias. Default is false"},
              "include_source_on_error" => {"type"=>"boolean", "default"=>true, "description"=>"True or false if to include the document source in the error message in case of parsing errors. Defaults to true."},
            }
          }
        ),
        "update_by_query" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-update-by-query.html",
          methods: ["POST"],
          body: {"description"=>"The search definition using the Query DSL"},
          url: {
            ...
            params: {
              ...
              "q" => {"type"=>"string", "description"=>"Query in the Lucene query string syntax"},
              "routing" => {"type"=>"list", "description"=>"A comma-separated list of specific routing values"},
              "scroll" => {"type"=>"time", "default"=>"5m", "description"=>"Specify how long a consistent view of the index should be maintained for scrolled search"},
              "search_type" => {"type"=>"enum", "options"=>["query_then_fetch", "dfs_query_then_fetch"], "description"=>"Search operation type"},
              "search_timeout" => {"type"=>"time", "description"=>"Explicit timeout for each search request. Defaults to no timeout."},
              "max_docs" => {"type"=>"number", "description"=>"Maximum number of documents to process (default: all documents)"},
              "sort" => {"type"=>"list", "description"=>"A comma-separated list of <field>:<direction> pairs"},
              ...
              "scroll_size" => {"type"=>"number", "default"=>1000, "description"=>"Size on the scroll request powering the update by query"},
        ...
        "update_by_query_rethrottle" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/docs-update-by-query.html#docs-update-by-query-rethrottle",
          methods: ["POST"],
          body: nil,
          url: {
            ...
            params: {
              "requests_per_second" => {"type"=>"number", "required"=>true, "default"=>-1, "description"=>"The throttle to set on this request in floating sub-requests per second. -1 means set no throttle."},
            }
          }
        ),
        "watcher.ack_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-ack-watch",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "watcher.activate_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-activate-watch",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "watcher.deactivate_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-deactivate-watch",
          methods: ["PUT", "POST"],
          body: nil,
          url: {
        ...
        "watcher.delete_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-delete-watch",
          methods: ["DELETE"],
          body: nil,
          url: {
        ...
        "watcher.execute_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-execute-watch",
          methods: ["PUT", "POST"],
          ...
          url: {
            ...
            params: {
              "debug" => {"type"=>"boolean", "default"=>false, "description"=>"indicates whether the watch should execute in debug mode"},
            }
          }
        ),
        "watcher.get_settings" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-get-settings",
          methods: ["GET"],
          body: nil,
          url: {
        ...
        "watcher.get_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-get-watch",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_watcher/watch/{id}",
        ...
        "watcher.put_watch" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-put-watch",
          methods: ["PUT", "POST"],
          body: {"description"=>"The watch", "required"=>true},
          url: {
            path: "/_watcher/watch/{id}",
            paths: ["/_watcher/watch/{id}"],
            parts: {
            ...
            params: {
              "active" => {"type"=>"boolean", "default"=>true, "description"=>"Specify whether the watch is in/active by default"},
              "version" => {"type"=>"number", "description"=>"Explicit version number for concurrency control"},
        ...
        "watcher.query_watches" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-query-watches",
          methods: ["GET", "POST"],
          body: {"description"=>"From, size, query, sort and search_after", "required"=>false},
          url: {
        ...
        "watcher.start" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-start",
          methods: ["POST"],
          body: nil,
          url: {
        ...
        "watcher.stats" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-stats",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_watcher/stats",
            ...
            params: {
              "metric" => {"type"=>"list", "options"=>["_all", "queued_watches", "current_watches", "pending_watches"], "description"=>"Controls what additional stat metrics should be include in the response"},
              "emit_stacktraces" => {"type"=>"boolean", "default"=>false, "description"=>"Emits stack traces of currently running watches"},
            }
          }
        ),
        "watcher.stop" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-stop",
          methods: ["POST"],
          body: nil,
          url: {
            path: "/_watcher/_stop",
        ...
        "watcher.update_settings" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-watcher-update-settings",
          methods: ["PUT"],
          ...
          url: {
            ...
            paths: ["/_watcher/settings"],
            params: {
              "timeout" => {"type"=>"time", "description"=>"Specify timeout for waiting for acknowledgement from all nodes"},
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for connection to master"},
            }
          }
        ),
        "xpack.info" => RestApi.new(
          documentation: "https://www.elastic.co/guide/en/elasticsearch/reference/8.19/info-api.html",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_xpack",
            paths: ["/_xpack"],
            params: {
              "human" => {"type"=>"boolean", "description"=>"Defines whether additional human-readable information is included in the response. In particular, it adds descriptions and a tag line. The default value is true.", "default"=>true},
        ...
        "xpack.usage" => RestApi.new(
          documentation: "https://www.elastic.co/docs/api/doc/elasticsearch/v8/group/endpoint-xpack",
          methods: ["GET"],
          body: nil,
          url: {
            path: "/_xpack/usage",
            paths: ["/_xpack/usage"],
            params: {
              "master_timeout" => {"type"=>"time", "default"=>"30s", "description"=>"Specify timeout for watch write operation"},
            }
          }
        ),
      }
